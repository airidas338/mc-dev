...
public abstract class xm extends Entity {
   ...
   public void K() throws IOException {
      ...
      if(this.ai()) {
         if(this.aj()) {
            ...
            if(var2 < 0.0D) {
               this.a(wh.e, (float)Math.max(1, MathHelper.c(-var2 * this.o.af().n())));
            }
         }
      }
      ...
      if(this.av == 20) {
         ...
         if(!this.o.D && (this.aM > 0 || this.ba()) && this.aZ() && this.o.Q().b("doMobLoot")) {
            ...
            while(var1 > 0) {
               int var2 = xk.a(var1);
               var1 -= var2;
               this.o.d((Entity)(new xk(this.o, this.s, this.t, this.u, var2)));
            }
         }
   ...
   protected void bE() {
      ...
      if(this.ax()) {
         ...
         this.v -= (double)(MathHelper.a(var1) * 0.2F);
         this.x += (double)(MathHelper.b(var1) * 0.2F);
      }
