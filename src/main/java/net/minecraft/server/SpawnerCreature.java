...
public final class SpawnerCreature {
   ...
   public static boolean a(xo var0, World var1, Location var2) {
      if(!var1.af().a(var2)) {
         ...
         if(var0 == xo.c) {
            return var3.getMaterial().isLiquid() && var1.getData(var2.b()).c().getMaterial().isLiquid() && !var1.getData(var2.a()).c().t();
         } else {
            ...
            if(!World.a((IBlockAccess)var1, var4)) {
               ...
               return var6 && !var3.t() && !var3.getMaterial().isLiquid() && !var1.getData(var2.a()).c().t();
            }
         }
      }
   }
