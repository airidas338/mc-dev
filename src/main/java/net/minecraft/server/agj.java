...
public class agj extends afm {
   ...
   protected void n() {
      this.i.a(4, new zk(this, agp.class, 1.0D, true));
   ...
   public void m() throws IOException {
      ...
      if(this.av() && this.u() != null && this.m instanceof abr) {
         ((xn)this.m).s().a(this.s().j(), 1.5D);
      }
   ...
   public boolean a(wh var1, float var2) {
      if(super.a(var1, var2)) {
         xm var3 = this.u();
         if(var3 == null && var1.j() instanceof xm) {
            var3 = (xm)var1.j();
         }

         if(var3 != null && this.o.aa() == EnumDifficulty.d && (double)this.V.nextFloat() < this.a(b).e()) {
   ...
   protected void a(vu var1) {
      super.a(var1);
      if(this.V.nextFloat() < (this.o.aa() == EnumDifficulty.d?0.05F:0.01F)) {
   ...
   public void a(xm var1) {
      super.a(var1);
      if((this.o.aa() == EnumDifficulty.c || this.o.aa() == EnumDifficulty.d) && var1 instanceof agp) {
         if(this.o.aa() != EnumDifficulty.d && this.V.nextBoolean()) {
            return;
         }
