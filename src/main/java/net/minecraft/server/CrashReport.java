...
public class CrashReport {
   ...
   public CrashReportSystemDetails a(String var1) {
      return this.a(var1, 1);
   }

   public CrashReportSystemDetails a(String var1, int var2) {
      CrashReportSystemDetails var3 = new CrashReportSystemDetails(this, var1);
      if(this.g) {
