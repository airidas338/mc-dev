...
public class ju implements Packet {
   ...
   public ju(ew var1, boolean var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int ... var11) {
      this.a = var1;
      this.j = var2;
      this.b = var3;
      this.c = var4;
