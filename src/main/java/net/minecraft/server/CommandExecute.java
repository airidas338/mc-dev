...
public class CommandExecute extends CommandAbstract {
   ...
   public void execute(ICommandListener var1, String[] var2) throws CommandException {
      if(var2.length < 5) {
         ...
         if("detect".equals(var2[4]) && var2.length > 10) {
            ...
            IBlockData var22 = var12.getData(var21);
   ...
   public List tabComplete(ICommandListener var1, String[] var2, Location var3) {
      return var2.length == 1?a(var2, MinecraftServer.M().I()):(var2.length > 1 && var2.length <= 4?a(var2, 1, var3):(var2.length > 5 && var2.length <= 8 && "detect".equals(var2[4])?a(var2, 5, var3):(var2.length == 9 && "detect".equals(var2[4])?a(var2, Block.REGISTRY.c()):null)));
   }
