...
public abstract class afm extends xu implements aex {
   ...
   public void s_() throws IOException {
      super.s_();
      if(!this.o.D && this.o.aa() == EnumDifficulty.a) {
         this.J();
      }
   ...
   public boolean r(Entity var1) {
      ...
      if(var4) {
         if(var3 > 0) {
            var1.g((double)(-MathHelper.a(this.y * 3.1415927F / 180.0F) * (float)var3 * 0.5F), 0.1D, (double)(MathHelper.b(this.y * 3.1415927F / 180.0F) * (float)var3 * 0.5F));
            this.v *= 0.6D;
            this.x *= 0.6D;
         }
   ...
   public boolean bQ() {
      return this.o.aa() != EnumDifficulty.a && this.m_() && super.bQ();
   }
