...
public class cr extends CommandAbstract {
   ...
   private int a(cs var1, double var2, World var4, Random var5, double var6, double var8, double var10, double var12, cs[] var14, boolean var15) throws di {
      boolean var16 = true;
