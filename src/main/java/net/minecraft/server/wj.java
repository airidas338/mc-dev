...
public class wj extends wi {
   ...
   public IChatBaseComponent b(EntityLiving var1) {
      ...
      return var3 != null && var3.s() && fi.c(var5)?new ChatMessage(var5, new Object[]{var1.getScoreboardDisplayName(), var2, var3.C()}):new ChatMessage(var4, new Object[]{var1.getScoreboardDisplayName(), var2});
   }
}
