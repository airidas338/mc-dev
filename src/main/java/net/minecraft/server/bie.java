...
public class bie extends WorldGenerator {
   ...
   private static final List c = Lists.newArrayList(new StructurePieceTreaasure[]{new StructurePieceTreaasure(Items.aA, 0, 1, 1, 10), new StructurePieceTreaasure(Items.j, 0, 1, 4, 10), new StructurePieceTreaasure(Items.P, 0, 1, 1, 10), new StructurePieceTreaasure(Items.O, 0, 1, 4, 10), new StructurePieceTreaasure(Items.H, 0, 1, 4, 10), new StructurePieceTreaasure(Items.F, 0, 1, 4, 10), new StructurePieceTreaasure(Items.BUCKET, 0, 1, 1, 10), new StructurePieceTreaasure(Items.ao, 0, 1, 1, 1), new StructurePieceTreaasure(Items.aC, 0, 1, 4, 10), new StructurePieceTreaasure(Items.cq, 0, 1, 1, 4), new StructurePieceTreaasure(Items.cr, 0, 1, 1, 4), new StructurePieceTreaasure(Items.co, 0, 1, 1, 10), new StructurePieceTreaasure(Items.cl, 0, 1, 1, 2), new StructurePieceTreaasure(Items.ck, 0, 1, 1, 5), new StructurePieceTreaasure(Items.cm, 0, 1, 1, 1)});
