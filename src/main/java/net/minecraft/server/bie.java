...
public class bie extends bhp {
   ...
   private static final List c = Lists.newArrayList(new vl[]{new vl(amk.aA, 0, 1, 1, 10), new vl(amk.j, 0, 1, 4, 10), new vl(amk.P, 0, 1, 1, 10), new vl(amk.O, 0, 1, 4, 10), new vl(amk.H, 0, 1, 4, 10), new vl(amk.F, 0, 1, 4, 10), new vl(amk.aw, 0, 1, 1, 10), new vl(amk.ao, 0, 1, 1, 1), new vl(amk.aC, 0, 1, 4, 10), new vl(amk.cq, 0, 1, 1, 4), new vl(amk.cr, 0, 1, 1, 4), new vl(amk.co, 0, 1, 1, 10), new vl(amk.cl, 0, 1, 1, 2), new vl(amk.ck, 0, 1, 1, 5), new vl(amk.cm, 0, 1, 1, 1)});
            ...
            while(true) {
               if(var15 < 3) {
                  label100: {
                     ...
                     dt var25 = new dt(var16, var24, var26);
                     if(var1.d(var25)) {
                        int var20 = 0;
                        ...
                        if(var20 == 1) {
                           ...
                           List var28 = vl.a(c, new vl[]{amk.cd.b(var2)});
                           bcm var27 = var1.s(var25);
                           if(var27 instanceof bcr) {
                              vl.a(var2, var28, (vq)((bcr)var27), 8);
                           }
                           break label100;
                        }
                     }
