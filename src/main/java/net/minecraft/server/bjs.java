...
public class bjs extends bkb {
   ...
   public boolean a(World var1, Random var2, bjb var3) {
      ...
      for(int var5 = 0; var5 <= 9; ++var5) {
         ...
         if((var5 & 1) == 0) {
            this.a(var1, var3, 0, var6 + 2, var5, 0, var6 + 3, var5, Blocks.NETHER_FENCE.P(), Blocks.NETHER_FENCE.P(), false);
            this.a(var1, var3, 4, var6 + 2, var5, 4, var6 + 3, var5, Blocks.NETHER_FENCE.P(), Blocks.NETHER_FENCE.P(), false);
         }
