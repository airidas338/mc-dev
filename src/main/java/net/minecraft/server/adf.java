...
public class adf extends afm implements afr {
      ...
      if(this.cj() > 0) {
         ...
         for(var1 = 1; var1 < 3; ++var1) {
            if(this.W >= this.bm[var1 - 1]) {
               ...
               if(this.o.aa() == EnumDifficulty.c || this.o.aa() == EnumDifficulty.d) {
                  int var10001 = var1 - 1;
               ...
               if(var12 > 0) {
                  ...
                  List var13 = this.o.a(xm.class, this.aQ().b(20.0D, 8.0D, 20.0D), Predicates.and(bp, xe.d));

                  for(int var16 = 0; var16 < 10 && !var13.isEmpty(); ++var16) {
                     xm var5 = (xm)var13.get(this.V.nextInt(var13.size()));
   ...
   private void a(int var1, xm var2) {
   ...
   public boolean a(wh var1, float var2) {
      if(this.b(var1)) {
         ...
         if(this.cj() > 0 && var1 != wh.j) {
            ...
            var3 = var1.j();
            if(var3 != null && !(var3 instanceof ahd) && var3 instanceof xm && ((xm)var3).by() == this.by()) {
               return false;
            } else {
               if(this.bo <= 0) {
                  this.bo = 20;
