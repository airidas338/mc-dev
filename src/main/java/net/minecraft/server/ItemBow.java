...
public class ItemBow extends Item {
   ...
   public void a(ItemStack var1, World var2, EntityHuman var3, int var4) {
      boolean var5 = var3.by.canInstantlyBuild || EnchantmentManager.getEnchantmentLevel(Enchantment.ARROW_INFINITE.B, var1) > 0;
      if(var5 || var3.bg.b(Items.g)) {
         ...
         int var9 = EnchantmentManager.getEnchantmentLevel(Enchantment.ARROW_DAMAGE.B, var1);
         if(var9 > 0) {
            var8.b(var8.j() + (double)var9 * 0.5D + 0.5D);
         }

         int var10 = EnchantmentManager.getEnchantmentLevel(Enchantment.ARROW_KNOCKBACK.B, var1);
         if(var10 > 0) {
            var8.a(var10);
         }

         if(EnchantmentManager.getEnchantmentLevel(Enchantment.ARROW_FIRE.B, var1) > 0) {
            var8.e(100);
         }
