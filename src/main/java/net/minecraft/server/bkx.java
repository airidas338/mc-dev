...
public class bkx extends blb {
   ...
   public bkx(EnumFacing var1, blf var2, Random var3) {
      super(1, var1, var2, 1, 2, 2);
   }

   public boolean a(World var1, Random var2, bjb var3) {
      blf var4 = this.k.b[EnumFacing.NORTH.a()];
      blf var5 = this.k;
      blf var6 = var4.b[EnumFacing.UP.a()];
      blf var7 = var5.b[EnumFacing.UP.a()];
      if(this.k.a / 25 > 0) {
         this.a(var1, var3, 0, 8, var4.c[EnumFacing.DOWN.a()]);
