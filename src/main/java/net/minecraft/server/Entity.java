...
public abstract class Entity implements ae {
   ...
   public void a(float var1, float var2, float var3) {
      ...
      if(var4 >= 1.0E-4F) {
         ...
         var1 *= var4;
         var2 *= var4;
         float var5 = MathHelper.a(this.y * 3.1415927F / 180.0F);
         float var6 = MathHelper.b(this.y * 3.1415927F / 180.0F);
   ...
   public boolean e(ahd var1) throws IOException {
      return false;
   }
   ...
   public boolean a(ahd var1, ChunkCoordinates var2) {
      return false;
   }
