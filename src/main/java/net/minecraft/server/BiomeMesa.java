...
public class BiomeMesa extends BiomeBase {
   ...
   public BiomeMesa(int var1, boolean var2, boolean var3) {
      ...
      this.a(2.0F, 0.0F);
      this.au.clear();
      this.ak = Blocks.m.P().a(BlockSand.a, bac.b);
      this.al = Blocks.cu.P();
      this.as.A = -999;
      this.as.D = 20;
      this.as.F = 3;
   ...
   public void a(World var1, Random var2, bgk var3, int var4, int var5, double var6) {
      ...
      for(int var19 = 255; var19 >= 0; --var19) {
         if(var3.a(var11, var19, var10).c().r() == Material.AIR && var19 < (int)var22) {
            var3.a(var11, var19, var10, Blocks.b.P());
         }

         if(var19 <= var2.nextInt(5)) {
            var3.a(var11, var19, var10, Blocks.h.P());
         } else {
               ...
               if(var17 == -1) {
                  ...
                  if(var19 >= 62) {
                     if(this.aJ && var19 > 86 + var15 * 2) {
                        if(var25) {
                           var3.a(var11, var19, var10, Blocks.d.P().a(BlockDirt.a, avd.b));
                        } else {
                           var3.a(var11, var19, var10, Blocks.c.P());
                        }
