...
public class EntityEgg extends EntityProjectile {
   ...
   protected void a(MovingObjectPosition var1) {
      ...
      for(int var6 = 0; var6 < 8; ++var6) {
         this.o.a(EnumParticleEffect.K, this.s, this.t, this.u, ((double)this.V.nextFloat() - 0.5D) * 0.08D, ((double)this.V.nextFloat() - 0.5D) * 0.08D, ((double)this.V.nextFloat() - 0.5D) * 0.08D, new int[]{Item.getId(Items.aP)});
      }
