...
public class avf extends Block {
   ...
   public boolean a(World var1, Location var2, IBlock var3, EntityHuman var4, ej var5, float var6, float var7, float var8) {
      if(this.J == Material.f) {
         ...
         IBlock var10 = var2.equals(var9)?var3:var1.p(var9);
         if(var10.c() != this) {
            return false;
         } else {
            var3 = var10.a(b);
   ...
   public void a(World var1, Location var2, boolean var3) {
      ...
      if(var4.c() == this) {
         ...
         IBlock var6 = var2 == var5?var4:var1.p(var5);
   ...
   public static int e(ard var0, Location var1) {
      IBlock var2 = var0.p(var1);
      int var3 = var2.c().c(var2);
      boolean var4 = i(var3);
      IBlock var5 = var0.p(var1.b());
      int var6 = var5.c().c(var5);
      int var7 = var4?var6:var3;
      IBlock var8 = var0.p(var1.a());
   ...
   private alq j() {
      return this == aty.aA?Items.aB:(this == aty.ap?Items.ar:(this == aty.aq?Items.as:(this == aty.ar?Items.at:(this == aty.as?Items.au:(this == aty.at?Items.av:Items.aq)))));
   }
   ...
   public static boolean f(ard var0, Location var1) {
      return g(e(var0, var1));
   }

   public static ej h(ard var0, Location var1) {
