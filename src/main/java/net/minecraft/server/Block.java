...
public class Block {
   ...
   public static final CreativeModeTab c = new CreativeModeTab(a);
   ...
   public static int f(IBlock var0) {
   ...
   public static IBlock d(int var0) {
      int var1 = var0 & 4095;
      int var2 = var0 >> 12 & 15;
      return c(var1).a(var2);
   }

   public static Block a(alq var0) {
   ...
   public final void b(World var1, Location var2, IBlock var3, int var4) {
   ...
   protected final void j(IBlock var1) {
      this.M = var1;
   }

   public final IBlock P() {
      return this.M;
   }
   ...
   public static void R() {
      ...
      Block var0 = (new Block(Material.e)).c(2.0F).b(10.0F).a(i).c("stonebrick").a(akf.b);
      a(4, "cobblestone", var0);
      Block var1 = (new ayw()).c(2.0F).b(5.0F).a(f).c("wood");
      a(5, "planks", var1);
      a(6, "sapling", (new baf()).c(0.0F).a(h).c("sapling"));
      a(7, "bedrock", (new Block(Material.e)).v().b(6000000.0F).a(i).c("bedrock").J().a(akf.b));
      a(8, "flowing_water", (new avn(Material.h)).c(100.0F).e(3).c("water").J());
      a(9, "water", (new bax(Material.h)).c(100.0F).e(3).c("water").J());
      a(10, "flowing_lava", (new avn(Material.i)).c(100.0F).a(1.0F).c("lava").J());
      a(11, "lava", (new bax(Material.i)).c(100.0F).a(1.0F).c("lava").J());
      ...
      a(20, "glass", (new awl(Material.s, false)).c(0.3F).a(k).c("glass"));
      ...
      a(35, "wool", (new aun(Material.n)).c(0.8F).a(l).c("cloth"));
      ...
      Block var5 = (new Block(Material.e)).c(2.0F).b(10.0F).a(i).c("brick").a(akf.b);
      a(45, "brick_block", var5);
      a(46, "tnt", (new bbk()).c(0.0F).a(h).c("tnt"));
      a(47, "bookshelf", (new aua()).c(1.5F).a(f).c("bookshelf"));
      a(48, "mossy_cobblestone", (new Block(Material.e)).c(2.0F).b(10.0F).a(i).c("stoneMoss").a(akf.b));
      ...
      a(64, "wooden_door", (new avf(Material.d)).c(3.0F).a(f).c("doorOak").J());
      ...
      a(70, "stone_pressure_plate", (new azf(Material.e, azh.b)).c(0.5F).a(i).c("pressurePlateStone"));
      a(71, "iron_door", (new avf(Material.f)).c(5.0F).a(j).c("doorIron").J());
      a(72, "wooden_pressure_plate", (new azf(Material.d, azh.a)).c(0.5F).a(f).c("pressurePlateWood"));
      ...
      a(85, "fence", (new avv(Material.d)).c(2.0F).b(5.0F).a(f).c("fence"));
      ...
      a(89, "glowstone", (new awm(Material.s)).c(0.3F).a(k).a(1.0F).c("lightgem"));
      ...
      a(95, "stained_glass", (new bar(Material.s)).c(0.3F).a(k).c("stainedGlass"));
      a(96, "trapdoor", (new bbp(Material.d)).c(3.0F).a(f).c("trapdoor").J());
      ...
      a(99, "brown_mushroom_block", (new awz(Material.d, var3)).c(0.2F).a(f).c("mushroom"));
      a(100, "red_mushroom_block", (new awz(Material.d, var4)).c(0.2F).a(f).c("mushroom"));
      a(101, "iron_bars", (new bbj(Material.f, true)).c(5.0F).b(10.0F).a(j).c("fenceIron"));
      a(102, "glass_pane", (new bbj(Material.s, false)).c(0.3F).a(k).c("thinGlass"));
      ...
      Block var10 = (new ayd()).c(2.0F).b(10.0F).a(i).c("netherBrick").a(akf.b);
      a(112, "nether_brick", var10);
      a(113, "nether_brick_fence", (new avv(Material.e)).c(2.0F).b(10.0F).a(i).c("netherFence"));
      ...
      a(119, "end_portal", (new avp(Material.E)).c(-1.0F).b(6000000.0F));
      a(120, "end_portal_frame", (new avq()).a(k).a(0.125F).c(-1.0F).c("endPortalFrame").b(6000000.0F).a(akf.c));
      a(121, "end_stone", (new Block(Material.e)).c(3.0F).b(15.0F).a(i).c("whiteStone").a(akf.b));
      ...
      a(147, "light_weighted_pressure_plate", (new bcd("gold_block", Material.f, 15)).c(0.5F).a(f).c("weightedPlate_light"));
      a(148, "heavy_weighted_pressure_plate", (new bcd("iron_block", Material.f, 150)).c(0.5F).a(f).c("weightedPlate_heavy"));
      ...
      a(159, "stained_hardened_clay", (new aun(Material.e)).c(1.25F).b(7.0F).a(i).c("clayHardenedStained"));
      ...
      a(167, "iron_trapdoor", (new bbp(Material.f)).c(5.0F).a(j).c("ironTrapdoor").J());
      a(168, "prismarine", (new azi()).c(1.5F).b(10.0F).a(i).c("prismarine"));
      a(169, "sea_lantern", (new bah(Material.s)).c(0.3F).a(k).a(1.0F).c("seaLantern"));
      ...
      a(173, "coal_block", (new Block(Material.e)).c(5.0F).b(10.0F).a(i).c("blockCoal").a(akf.b));
      ...
      a(188, "spruce_fence", (new avv(Material.d)).c(2.0F).b(5.0F).a(f).c("spruceFence"));
      a(189, "birch_fence", (new avv(Material.d)).c(2.0F).b(5.0F).a(f).c("birchFence"));
      a(190, "jungle_fence", (new avv(Material.d)).c(2.0F).b(5.0F).a(f).c("jungleFence"));
      a(191, "dark_oak_fence", (new avv(Material.d)).c(2.0F).b(5.0F).a(f).c("darkOakFence"));
      a(192, "acacia_fence", (new avv(Material.d)).c(2.0F).b(5.0F).a(f).c("acaciaFence"));
      a(193, "spruce_door", (new avf(Material.d)).c(3.0F).a(f).c("doorSpruce").J());
      a(194, "birch_door", (new avf(Material.d)).c(3.0F).a(f).c("doorBirch").J());
      a(195, "jungle_door", (new avf(Material.d)).c(3.0F).a(f).c("doorJungle").J());
      a(196, "acacia_door", (new avf(Material.d)).c(3.0F).a(f).c("doorAcacia").J());
      a(197, "dark_oak_door", (new avf(Material.d)).c(3.0F).a(f).c("doorDarkOak").J());
      c.a();
      ...
      while(var13.hasNext()) {
         ...
         while(var22.hasNext()) {
            IBlock var21 = (IBlock)var22.next();
