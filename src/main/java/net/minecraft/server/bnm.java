...
public class bnm extends bnn {
   ...
   public boolean a(World var1, Random var2, bjb var3) {
      ...
      this.a(var1, var3, 2, 0, 5, 8, 0, 10, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 1, 0, 1, 7, 0, 4, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 0, 0, 0, 0, 3, 5, aty.e.P(), aty.e.P(), false);
      this.a(var1, var3, 8, 0, 0, 8, 3, 10, aty.e.P(), aty.e.P(), false);
      this.a(var1, var3, 1, 0, 0, 7, 2, 0, aty.e.P(), aty.e.P(), false);
      this.a(var1, var3, 1, 0, 5, 2, 1, 5, aty.e.P(), aty.e.P(), false);
      this.a(var1, var3, 2, 0, 6, 2, 3, 10, aty.e.P(), aty.e.P(), false);
      this.a(var1, var3, 3, 0, 10, 7, 3, 10, aty.e.P(), aty.e.P(), false);
      this.a(var1, var3, 1, 2, 0, 7, 3, 0, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 1, 2, 5, 2, 3, 5, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 0, 4, 1, 8, 4, 1, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 0, 4, 4, 3, 4, 4, aty.f.P(), aty.f.P(), false);
      ...
      this.a(var1, aty.f.P(), 8, 4, 4, var3);
      ...
      this.a(var1, var3, 3, 4, 5, 3, 4, 10, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 7, 4, 2, 7, 4, 10, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 4, 5, 4, 4, 5, 10, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 6, 5, 4, 6, 5, 10, aty.f.P(), aty.f.P(), false);
      this.a(var1, var3, 5, 6, 3, 5, 6, 10, aty.f.P(), aty.f.P(), false);
      var6 = this.a(aty.ad, 0);

      int var8;
      for(var7 = 4; var7 >= 1; --var7) {
         this.a(var1, aty.f.P(), var7, 2 + var7, 7 - var7, var3);

         for(var8 = 8 - var7; var8 <= 10; ++var8) {
            this.a(var1, aty.ad.a(var6), var7, 2 + var7, var8, var3);
         }
      }

      var7 = this.a(aty.ad, 1);
      this.a(var1, aty.f.P(), 6, 6, 3, var3);
      this.a(var1, aty.f.P(), 7, 5, 4, var3);
      this.a(var1, aty.ad.a(var7), 6, 6, 4, var3);

      int var9;
      for(var8 = 6; var8 <= 8; ++var8) {
         for(var9 = 5; var9 <= 10; ++var9) {
            this.a(var1, aty.ad.a(var7), var8, 12 - var8, var9, var3);
         }
      }
      ...
      this.a(var1, aty.r.P(), 4, 2, 0, var3);
      this.a(var1, aty.bj.P(), 5, 2, 0, var3);
      this.a(var1, aty.r.P(), 6, 2, 0, var3);
      ...
      this.a(var1, aty.f.P(), 8, 2, 5, var3);
      this.a(var1, aty.r.P(), 8, 2, 6, var3);
      this.a(var1, aty.bj.P(), 8, 2, 7, var3);
      this.a(var1, aty.bj.P(), 8, 2, 8, var3);
      this.a(var1, aty.r.P(), 8, 2, 9, var3);
      this.a(var1, aty.r.P(), 2, 2, 6, var3);
      this.a(var1, aty.bj.P(), 2, 2, 7, var3);
      this.a(var1, aty.bj.P(), 2, 2, 8, var3);
      this.a(var1, aty.r.P(), 2, 2, 9, var3);
      this.a(var1, aty.r.P(), 4, 4, 10, var3);
      this.a(var1, aty.bj.P(), 5, 4, 10, var3);
      this.a(var1, aty.r.P(), 6, 4, 10, var3);
      this.a(var1, aty.f.P(), 5, 5, 10, var3);
      ...
      for(var8 = 0; var8 < 5; ++var8) {
         for(var9 = 0; var9 < 9; ++var9) {
            ...
            this.b(var1, aty.e.P(), var9, -1, var8, var3);
         }
      }
