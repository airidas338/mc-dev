   ...
   public void m() throws IOException {
      ...
      if(this.bm() <= 0.0F) {
         ...
         if(this.o.D) {
            ...
            var16 = (double)(-MathHelper.b(this.y * 3.1415927F / 180.0F));
            ChunkCoordinates var18 = (new ChunkCoordinates((double)MathHelper.a(this.y * 3.1415927F / 180.0F), this.w, var16)).a();
         ...
         var35 = MathHelper.a(this.y * 3.1415927F / 180.0F - this.aZ * 0.01F);
         float var34 = MathHelper.b(this.y * 3.1415927F / 180.0F - this.aZ * 0.01F);
         this.bl.s_();
         ...
         for(int var32 = 0; var32 < 3; ++var32) {
            ...
            float var40 = MathHelper.a(var36);
            float var39 = MathHelper.b(var36);
            float var38 = 1.5F;
