               ...
               for(var4 = -1; var4 <= 1; ++var4) {
                  for(int var5 = -1; var5 <= 1; ++var5) {
                     if((var4 != 0 || var5 != 0) && this.i.d(this.j.a(var5, 0, var4)) && this.i.d(this.j.a(var5, 1, var4))) {
                        if(this.i.getData(this.j.a(var5 * 2, 0, var4 * 2)).c() == Blocks.X) {
                           ++var3;
                        }

                        if(this.i.getData(this.j.a(var5 * 2, 1, var4 * 2)).c() == Blocks.X) {
                           ++var3;
                        }

                        if(var5 != 0 && var4 != 0) {
                           if(this.i.getData(this.j.a(var5 * 2, 0, var4)).c() == Blocks.X) {
                              ++var3;
                           }

                           if(this.i.getData(this.j.a(var5 * 2, 1, var4)).c() == Blocks.X) {
                              ++var3;
                           }

                           if(this.i.getData(this.j.a(var5, 0, var4 * 2)).c() == Blocks.X) {
                              ++var3;
                           }

                           if(this.i.getData(this.j.a(var5, 1, var4 * 2)).c() == Blocks.X) {
                              ++var3;
                           }
                        }
                     }
