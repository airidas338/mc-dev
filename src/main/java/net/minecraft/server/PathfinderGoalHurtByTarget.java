...
public class PathfinderGoalHurtByTarget extends aaw {
   ...
   public void c() {
      ...
      if(this.a) {
         double var1 = this.f();
         List var3 = this.e.o.getEntities(this.e.getClass(), (new AxisAlignedBB(this.e.s, this.e.t, this.e.u, this.e.s + 1.0D, this.e.t + 1.0D, this.e.u + 1.0D)).b(var1, 10.0D, var1));
