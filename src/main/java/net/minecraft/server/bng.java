...
public class bng extends bnn {
   ...
   public boolean a(World var1, Random var2, bjb var3) {
      ...
      this.a(var1, var3, 0, 0, 0, 4, 0, 4, Blocks.e.P(), Blocks.e.P(), false);
      this.a(var1, var3, 0, 4, 0, 4, 4, 4, Blocks.r.P(), Blocks.r.P(), false);
      this.a(var1, var3, 1, 4, 1, 3, 4, 3, Blocks.f.P(), Blocks.f.P(), false);
      this.a(var1, Blocks.e.P(), 0, 1, 0, var3);
      this.a(var1, Blocks.e.P(), 0, 2, 0, var3);
      this.a(var1, Blocks.e.P(), 0, 3, 0, var3);
      this.a(var1, Blocks.e.P(), 4, 1, 0, var3);
      this.a(var1, Blocks.e.P(), 4, 2, 0, var3);
      this.a(var1, Blocks.e.P(), 4, 3, 0, var3);
      this.a(var1, Blocks.e.P(), 0, 1, 4, var3);
      this.a(var1, Blocks.e.P(), 0, 2, 4, var3);
      this.a(var1, Blocks.e.P(), 0, 3, 4, var3);
      this.a(var1, Blocks.e.P(), 4, 1, 4, var3);
      this.a(var1, Blocks.e.P(), 4, 2, 4, var3);
      this.a(var1, Blocks.e.P(), 4, 3, 4, var3);
      this.a(var1, var3, 0, 1, 1, 0, 3, 3, Blocks.f.P(), Blocks.f.P(), false);
      this.a(var1, var3, 4, 1, 1, 4, 3, 3, Blocks.f.P(), Blocks.f.P(), false);
      this.a(var1, var3, 1, 1, 4, 3, 3, 4, Blocks.f.P(), Blocks.f.P(), false);
      this.a(var1, Blocks.bj.P(), 0, 2, 2, var3);
      this.a(var1, Blocks.bj.P(), 2, 2, 4, var3);
      this.a(var1, Blocks.bj.P(), 4, 2, 2, var3);
      this.a(var1, Blocks.f.P(), 1, 1, 0, var3);
      this.a(var1, Blocks.f.P(), 1, 2, 0, var3);
      this.a(var1, Blocks.f.P(), 1, 3, 0, var3);
      this.a(var1, Blocks.f.P(), 2, 3, 0, var3);
      this.a(var1, Blocks.f.P(), 3, 3, 0, var3);
      this.a(var1, Blocks.f.P(), 3, 2, 0, var3);
      this.a(var1, Blocks.f.P(), 3, 1, 0, var3);
