            ...
            for(var30 = 0; var30 < 16; ++var30) {
               for(var8 = 4; var8 < 8; ++var8) {
                  if(var4[(var6 * 16 + var30) * 8 + var8]) {
                     ...
                     if(var1.getData(var32).c() == Blocks.d && var1.b(EnumSkyBlock.SKY, var3.a(var6, var8, var30)) > 0) {
                        BiomeBase var33 = var1.b(var32);
                        if(var33.ak.c() == Blocks.bw) {
                           var1.a(var32, Blocks.bw.P(), 2);
                        } else {
                           var1.a(var32, Blocks.c.P(), 2);
                        }
                     }
                  }
               }
               ...
               for(var30 = 0; var30 < 16; ++var30) {
                  for(var8 = 0; var8 < 8; ++var8) {
                     ...
                     if(var31 && (var8 < 4 || var2.nextInt(2) != 0) && var1.getData(var3.a(var6, var8, var30)).c().r().a()) {
                        var1.a(var3.a(var6, var8, var30), Blocks.b.P(), 2);
                     }
                  }
               }
            }
            ...
            for(var6 = 0; var6 < 16; ++var6) {
               for(var30 = 0; var30 < 16; ++var30) {
                  ...
                  if(var1.v(var3.a(var6, var34, var30))) {
                     var1.a(var3.a(var6, var34, var30), Blocks.aI.P(), 2);
                  }
               }
            }
         }
