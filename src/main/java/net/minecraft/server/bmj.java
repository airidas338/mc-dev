...
public class bmj extends bmk {
   ...
   public boolean a(World var1, Random var2, bjb var3) {
      if(this.a(var1, var3)) {
         ...
         int var4 = this.a(Blocks.COBBLESTONE_STAIRS, 2);

         for(int var5 = 0; var5 < 6; ++var5) {
            this.a(var1, Blocks.COBBLESTONE_STAIRS.a(var4), 1, 6 - var5, 1 + var5, var3);
            this.a(var1, Blocks.COBBLESTONE_STAIRS.a(var4), 2, 6 - var5, 1 + var5, var3);
            this.a(var1, Blocks.COBBLESTONE_STAIRS.a(var4), 3, 6 - var5, 1 + var5, var3);
            if(var5 < 5) {
               this.a(var1, Blocks.SMOOTH_BRICK.P(), 1, 5 - var5, 1 + var5, var3);
               this.a(var1, Blocks.SMOOTH_BRICK.P(), 2, 5 - var5, 1 + var5, var3);
               this.a(var1, Blocks.SMOOTH_BRICK.P(), 3, 5 - var5, 1 + var5, var3);
            }
         }
