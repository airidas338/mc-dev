...
public abstract class xn extends xm {
   ...
   protected void a(vu var1) {
      if(this.V.nextFloat() < 0.15F * var1.c()) {
         ...
         float var3 = this.o.aa() == EnumDifficulty.d?0.1F:0.25F;
   ...
   public final boolean e(ahd var1) throws IOException {
   ...
   protected boolean a(ahd var1) throws IOException {
      return false;
   }
