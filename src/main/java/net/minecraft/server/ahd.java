...
public abstract class ahd extends xm {
   ...
   public ahd(World var1, GameProfile var2) {
      super(var1);
      this.ao = a(var2);
      this.bF = var2;
   ...
   public void m() throws IOException {
      ...
      if(this.o.aa() == EnumDifficulty.a && this.o.Q().b("naturalRegeneration")) {
   ...
   public adw a(amj var1, boolean var2, boolean var3) {
      if(var1 == null) {
         ...
         if(var2) {
            ...
            var6.v = (double)(-MathHelper.a(var8) * var7);
            var6.x = (double)(MathHelper.b(var8) * var7);
            var6.w = 0.20000000298023224D;
         } else {
            var7 = 0.3F;
            var6.v = (double)(-MathHelper.a(this.y / 180.0F * 3.1415927F) * MathHelper.b(this.z / 180.0F * 3.1415927F) * var7);
            var6.x = (double)(MathHelper.b(this.y / 180.0F * 3.1415927F) * MathHelper.b(this.z / 180.0F * 3.1415927F) * var7);
            var6.w = (double)(-MathHelper.a(this.z / 180.0F * 3.1415927F) * var7 + 0.1F);
            var8 = this.V.nextFloat() * 3.1415927F * 2.0F;
   ...
   public boolean a(wh var1, float var2) {
      if(this.b(var1)) {
         ...
         if(this.bm() <= 0.0F) {
            ...
            if(var1.r()) {
               if(this.o.aa() == EnumDifficulty.a) {
                  var2 = 0.0F;
               }

               if(this.o.aa() == EnumDifficulty.b) {
                  var2 = var2 / 2.0F + 1.0F;
               }

               if(this.o.aa() == EnumDifficulty.d) {
                  var2 = var2 * 3.0F / 2.0F;
               }
            }
      ...
      if(var1.aE()) {
         if(!var1.l(this)) {
            ...
            if(var2 > 0.0F || var4 > 0.0F) {
               ...
               if(var14) {
                  if(var18 > 0) {
                     var1.g((double)(-MathHelper.a(this.y * 3.1415927F / 180.0F) * (float)var18 * 0.5F), 0.1D, (double)(MathHelper.b(this.y * 3.1415927F / 180.0F) * (float)var18 * 0.5F));
                     this.v *= 0.6D;
                     this.x *= 0.6D;
                     this.d(false);
                  }
