   ...
   public boolean generate(World var1, Random var2, Location var3) {
      for(int var4 = 0; var4 < 20; ++var4) {
         ...
         if(var1.isEmpty(var5)) {
            ...
            if(var1.getData(var6.e()).c().r() == Material.WATER || var1.getData(var6.f()).c().r() == Material.WATER || var1.getData(var6.c()).c().r() == Material.WATER || var1.getData(var6.d()).c().r() == Material.WATER) {
