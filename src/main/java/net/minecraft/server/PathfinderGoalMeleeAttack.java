...
public class PathfinderGoalMeleeAttack extends PathfinderGoal {
   ...
   public PathfinderGoalMeleeAttack(EntityCreature var1, Class var2, double var3, boolean var5) {
      this(var1, var3, var5);
      this.g = var2;
   }

   public PathfinderGoalMeleeAttack(EntityCreature var1, double var2, boolean var4) {
      this.b = var1;
      this.a = var1.o;
      this.d = var2;
      this.e = var4;
   ...
   public boolean b() {
      EntityLiving var1 = this.b.u();
      return var1 == null?false:(!var1.isAlive()?false:(!this.e?!this.b.getNavigation().m():this.b.d(new Location(var1))));
   }
