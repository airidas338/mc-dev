...
public class EntityVillager extends EntityAgeable implements ago, aqb {
   ...
   private boolean by;
   private wa bz;
   private static final agw[][][][] bA = new agw[][][][]{{{{new agr(Items.O, new agx(18, 22)), new agr(Items.bS, new agx(15, 19)), new agr(Items.bR, new agx(15, 19)), new agv(Items.P, new agx(-4, -2))}, {new agr(Item.a(aty.aU), new agx(8, 13)), new agv(Items.ca, new agx(-3, -2))}, {new agr(Item.a(aty.bk), new agx(7, 12)), new agv(Items.e, new agx(-5, -7))}, {new agv(Items.bc, new agx(-6, -10)), new agv(Items.aZ, new agx(1, 1))}}, {{new agr(Items.F, new agx(15, 20)), new agr(Items.h, new agx(16, 24)), new agu(Items.aU, new agx(6, 6), Items.aV, new agx(6, 6))}, {new agt(Items.aR, new agx(7, 8))}}, {{new agr(Item.a(aty.L), new agx(16, 22)), new agv(Items.be, new agx(3, 4))}, {new agv(new amj(Item.a(aty.L), 1, 0), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 1), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 2), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 3), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 4), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 5), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 6), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 7), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 8), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 9), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 10), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 11), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 12), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 13), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 14), new agx(1, 2)), new agv(new amj(Item.a(aty.L), 1, 15), new agx(1, 2))}}, {{new agr(Items.F, new agx(15, 20)), new agv(Items.g, new agx(-12, -8))}, {new agv(Items.f, new agx(2, 3)), new agu(Item.a(aty.n), new agx(10, 10), Items.ak, new agx(6, 10))}}}, {{{new agr(Items.aK, new agx(24, 36)), new ags()}, {new agr(Items.aL, new agx(8, 10)), new agv(Items.aQ, new agx(10, 12)), new agv(Item.a(aty.X), new agx(3, 4))}, {new agr(Items.bN, new agx(2, 2)), new agv(Items.aS, new agx(10, 12)), new agv(Item.a(aty.w), new agx(-5, -3))}, {new ags()}, {new ags()}, {new agv(Items.co, new agx(20, 22))}}}, {{{new agr(Items.bt, new agx(36, 40)), new agr(Items.k, new agx(8, 10))}, {new agv(Items.aC, new agx(-4, -1)), new agv(new amj(Items.aW, 1, akv.l.b()), new agx(-2, -1))}, {new agv(Items.bH, new agx(7, 11)), new agv(Item.a(aty.aX), new agx(-3, -1))}, {new agv(Items.bK, new agx(3, 11))}}}, {{{new agr(Items.h, new agx(16, 24)), new agv(Items.Y, new agx(4, 6))}, {new agr(Items.j, new agx(7, 9)), new agv(Items.Z, new agx(10, 14))}, {new agr(Items.i, new agx(3, 4)), new agt(Items.ad, new agx(16, 19))}, {new agv(Items.X, new agx(5, 7)), new agv(Items.W, new agx(9, 11)), new agv(Items.U, new agx(5, 7)), new agv(Items.V, new agx(11, 15))}}, {{new agr(Items.h, new agx(16, 24)), new agv(Items.c, new agx(6, 8))}, {new agr(Items.j, new agx(7, 9)), new agt(Items.l, new agx(9, 10))}, {new agr(Items.i, new agx(3, 4)), new agt(Items.u, new agx(12, 15)), new agt(Items.x, new agx(9, 12))}}, {{new agr(Items.h, new agx(16, 24)), new agt(Items.a, new agx(5, 7))}, {new agr(Items.j, new agx(7, 9)), new agt(Items.b, new agx(9, 11))}, {new agr(Items.i, new agx(3, 4)), new agt(Items.w, new agx(12, 15))}}}, {{{new agr(Items.al, new agx(14, 18)), new agr(Items.bk, new agx(14, 18))}, {new agr(Items.h, new agx(16, 24)), new agv(Items.am, new agx(-7, -5)), new agv(Items.bl, new agx(-8, -6))}}, {{new agr(Items.aF, new agx(9, 12)), new agv(Items.S, new agx(2, 4))}, {new agt(Items.R, new agx(7, 12))}, {new agv(Items.aA, new agx(8, 10))}}}};
