...
public class DedicatedServer extends MinecraftServer implements pj {
   ...
   protected boolean init() throws UnknownHostException {
      ThreadCommandHandler var1 = new ThreadCommandHandler(this, "Server console handler");
      var1.setDaemon(true);
      var1.start();
      ...
      this.n = new PropertyManager(new File("server.properties"));
      ...
      if(!this.o.a()) {
         ...
         int var2 = this.n.a("gamemode", EnumGamemode.SURVIVAL.a());
