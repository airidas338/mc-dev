...
public class bjn {
   ...
   private static bkb b(bkc var0, List var1, Random var2, int var3, int var4, int var5, ej var6, int var7) {
      Class var8 = var0.a;
      Object var9 = null;
      if(var8 == bjr.class) {
   ...
   // $FF: synthetic method
   static bkb a(bkc var0, List var1, Random var2, int var3, int var4, int var5, ej var6, int var7) {
