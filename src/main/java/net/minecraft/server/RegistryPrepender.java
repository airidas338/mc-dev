...
public class RegistryPrepender {

	protected final String a;
	protected final String b;

	protected RegistryPrepender(int var1, String... var2) {
		this.a = StringUtils.isEmpty(var2[0]) ? "minecraft" : var2[0].toLowerCase();
		this.b = var2[1];
		Validate.notNull(this.b);
	}

	public RegistryPrepender(String var1) {
		this(0, a(var1));
	}
	...
	public boolean equals(Object var1) {
		if (this == var1) {
			return true;
		} else if (!(var1 instanceof RegistryPrepender)) {
			return false;
		} else {
			RegistryPrepender var2 = (RegistryPrepender) var1;
