...
public class WorldBorder {
	...
	public EnumWorldBorderStatus a() {
		return this.e < this.d ? EnumWorldBorderStatus.SHRINKING : (this.e > this.d ? EnumWorldBorderStatus.GROWING : EnumWorldBorderStatus.STATIONARY);
	}
	...
	public void c(double var1, double var3) {
		...
		while (var5.hasNext()) {
			WorldBorderListener var6 = (WorldBorderListener) var5.next();
	...
	public double h() {
		if (this.a() != EnumWorldBorderStatus.STATIONARY) {
	...
	public long i() {
		return this.a() != EnumWorldBorderStatus.STATIONARY ? this.f - System.currentTimeMillis() : 0L;
	}
	...
	public void a(double var1) {
		...
		while (var3.hasNext()) {
			WorldBorderListener var4 = (WorldBorderListener) var3.next();
			var4.a(this, var1);
		}
	...
	public void a(double var1, double var3, long var5) {
		...
		while (var7.hasNext()) {
			WorldBorderListener var8 = (WorldBorderListener) var7.next();
	...
	public void a(WorldBorderListener var1) {
		this.a.add(var1);
	}
	...
	public void b(int var1) {
		...
		while (var2.hasNext()) {
			WorldBorderListener var3 = (WorldBorderListener) var2.next();
			var3.a(this, var1);
		}
