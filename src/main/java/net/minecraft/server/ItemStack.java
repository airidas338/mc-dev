...
public final class ItemStack {
    ...
    public boolean placeItem(EntityHuman var1, World var2, Location var3, EnumFacing var4, float var5, float var6, float var7) {
    ...
    public NBTTagCompound save(NBTTagCompound var1) {
        RegistryPrepender var2 = (RegistryPrepender) Item.e.c(this.item);
    ...
    public void c(NBTTagCompound var1) {
        if (var1.hasKeyOfType("id", 8)) {
            ...
            this.item = Item.b(var1.getShort("id"));
        }
    ...
    public void damage(int var1, EntityLiving var2) {
        if (!(var2 instanceof EntityHuman) || !((EntityHuman) var2).abilities.canInstantlyBuild) {
            if (this.e()) {
                if (this.isDamaged(var1, var2.bb())) {
                    var2.b(this);
                    --this.count;
    ...
    public boolean b(Block var1) {
        return this.item.canDestroySpecialBlocks(var1);
    }
    ...
    private boolean d(ItemStack var1) {
        return this.count != var1.count ? false : (this.item != var1.item ? false : (this.damage != var1.damage ? false : (this.tag == null && var1.tag != null ? false : this.tag == null
                || this.tag.equals(var1.tag))));
    }

    public static boolean doMaterialsMatch(ItemStack var0, ItemStack var1) {
    ...
    public String toString() {
        return this.count + "x" + this.item.a() + "@" + this.damage;
    }
    ...
    public ItemStack c(String var1) {
        ...
        if (!this.tag.hasKeyOfType("display", 10)) {
            this.tag.set("display", (NBTBase) (new NBTTagCompound()));
        }
