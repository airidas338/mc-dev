...
public class abt extends abq implements vr {
   ...
   protected abt a(Entity var1, double var2) {
   ...
   public void g(float var1, float var2) {
      if(this.l != null && this.l instanceof xm && this.cE()) {
         ...
         if(this.bp > 0.0F && !this.ct() && this.C) {
            ...
            this.ai = true;
            if(var2 > 0.0F) {
               float var3 = MathHelper.a(this.y * 3.1415927F / 180.0F);
               float var4 = MathHelper.b(this.y * 3.1415927F / 180.0F);
