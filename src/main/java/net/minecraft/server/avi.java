...
public class avi extends auc implements atz {
   ...
   public avk e(ard var1, Location var2) {
   ...
   public alq a(IBlock var1, Random var2, int var3) {
      if(var1.b(b) == avj.a) {
         ...
         return var4 == avk.d?null:(var4 == avk.c?(var2.nextInt(8) == 0?Items.N:null):alq.a((Block)this));
      }
   }
