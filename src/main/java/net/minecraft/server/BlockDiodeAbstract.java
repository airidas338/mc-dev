...
public abstract class BlockDiodeAbstract extends BlockDirectional {
   ...
   protected int f(World var1, Location var2, IBlockData var3) {
      ...
      if(var6 >= 15) {
         ...
         IBlockData var7 = var1.getData(var5);
         return Math.max(var6, var7.c() == Blocks.REDSTONE_WIRE?((Integer)var7.b(BlockRedstoneWire.O)).intValue():0);
      }
   }

   protected int c(IBlockAccess var1, Location var2, IBlockData var3) {
      EnumFacing var4 = (EnumFacing)var3.b(N);
   ...
   protected void h(World var1, Location var2, IBlockData var3) {
      EnumFacing var4 = (EnumFacing)var3.b(N);
   ...
   public boolean i(World var1, Location var2, IBlockData var3) {
