...
public class ah {
   ...
   public static EntityPlayer a(ae var0, String var1) {
      return (EntityPlayer)a(var0, var1, EntityPlayer.class);
   }

   public static Entity a(ae var0, String var1, Class var2) {
      List var3 = b(var0, var1, var2);
      return var3.size() == 1?(Entity)var3.get(0):null;
   }

   public static IChatBaseComponent b(ae var0, String var1) {
   ...
   private static List c(Map var0) {
      ArrayList var1 = Lists.newArrayList();
      int var2 = a(var0, "m", EnumGamemode.a.a());
      if(var2 != EnumGamemode.a.a()) {
