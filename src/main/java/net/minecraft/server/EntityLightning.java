...
public class EntityLightning extends EntityWeather {
   ...
   public EntityLightning(World var1, double var2, double var4, double var6) {
      ...
      if(!var1.D && var1.Q().b("doFireTick") && (var1.aa() == EnumDifficulty.NORMAL || var1.aa() == EnumDifficulty.HARD) && var1.a(new Location(this), (int)10)) {
         ...
         if(var1.getData(var8).c().r() == Material.AIR && aty.ab.c(var1, var8)) {
            var1.a(var8, aty.ab.P());
         }

         for(int var9 = 0; var9 < 4; ++var9) {
            Location var10 = var8.a(this.V.nextInt(3) - 1, this.V.nextInt(3) - 1, this.V.nextInt(3) - 1);
            if(var1.getData(var10).c().r() == Material.AIR && aty.ab.c(var1, var10)) {
   ...
   public void s_() throws IOException {
      ...
      if(this.b < 0) {
         if(this.c == 0) {
            ...
            if(!this.o.D && this.o.Q().b("doFireTick") && this.o.a(var1, (int)10) && this.o.getData(var1).c().r() == Material.AIR && aty.ab.c(this.o, var1)) {
