...
public class EntityFishingHook extends Entity {
   ...
   private static final List d = Arrays.asList(new PossibleFishingResult[]{(new PossibleFishingResult(new amj(Items.T), 10)).a(0.9F), new PossibleFishingResult(new amj(Items.aF), 10), new PossibleFishingResult(new amj(Items.aX), 10), new PossibleFishingResult(new amj(Items.bz), 10), new PossibleFishingResult(new amj(Items.F), 5), (new PossibleFishingResult(new amj(Items.aR), 2)).a(0.9F), new PossibleFishingResult(new amj(Items.z), 10), new PossibleFishingResult(new amj(Items.y), 5), new PossibleFishingResult(new amj(Items.aW, 10, akv.p.b()), 1), new PossibleFishingResult(new amj(aty.bR), 10), new PossibleFishingResult(new amj(Items.bt), 10)});
   private static final List e = Arrays.asList(new PossibleFishingResult[]{new PossibleFishingResult(new amj(aty.bx), 1), new PossibleFishingResult(new amj(Items.co), 1), new PossibleFishingResult(new amj(Items.aA), 1), (new PossibleFishingResult(new amj(Items.f), 1)).a(0.25F).a(), (new PossibleFishingResult(new amj(Items.aR), 1)).a(0.25F).a(), (new PossibleFishingResult(new amj(Items.aL), 1)).a()});
   ...
   public void s_() throws IOException {
      ...
      if(this.ax > 0) {
         ...
         if(this.aq) {
            if(this.o.getData(new Location(this.g, this.h, this.i)).c() == this.ap) {
               ++this.ar;
               if(this.ar == 1200) {
                  this.J();
               }
