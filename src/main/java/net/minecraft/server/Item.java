...
public class Item {
	...
	public static void t() {
		a(Blocks.STONE, (Item) (new ItemMultiTexture(Blocks.STONE, Blocks.STONE, new alr())).b("stone"));
		a((Block) Blocks.GRASS, (Item) (new ann(Blocks.GRASS, false)));
		a(Blocks.DIRT, (Item) (new ItemMultiTexture(Blocks.DIRT, Blocks.DIRT, new ama())).b("dirt"));
		c(Blocks.COBBLESTONE);
		a(Blocks.WOOD, (Item) (new ItemMultiTexture(Blocks.WOOD, Blocks.WOOD, new amb())).b("wood"));
		a(Blocks.SAPLING, (Item) (new ItemMultiTexture(Blocks.SAPLING, Blocks.SAPLING, new amc())).b("sapling"));
		c(Blocks.BEDROCK);
		a((Block) Blocks.SAND, (Item) (new ItemMultiTexture(Blocks.SAND, Blocks.SAND, new amd())).b("sand"));
		c(Blocks.GRAVEL);
		c(Blocks.GOLD_ORE);
		c(Blocks.IRON_ORE);
		c(Blocks.COAL_ORE);
		a(Blocks.LOG, (Item) (new ItemMultiTexture(Blocks.LOG, Blocks.LOG, new ame())).b("log"));
		a(Blocks.LOG2, (Item) (new ItemMultiTexture(Blocks.LOG2, Blocks.LOG2, new amf())).b("log"));
		a((Block) Blocks.LEAVES, (Item) (new amm(Blocks.LEAVES)).b("leaves"));
		a((Block) Blocks.LEAVES2, (Item) (new amm(Blocks.LEAVES2)).b("leaves"));
		a(Blocks.SPONGE, (Item) (new ItemMultiTexture(Blocks.SPONGE, Blocks.SPONGE, new amg())).b("sponge"));
		c(Blocks.GLASS);
		c(Blocks.LAPIS_ORE);
		c(Blocks.LAPIS_BLOCK);
		c(Blocks.DISPENSER);
		a(Blocks.SANDSTONE, (Item) (new ItemMultiTexture(Blocks.SANDSTONE, Blocks.SANDSTONE, new amh())).b("sandStone"));
		c(Blocks.NOTE_BLOCK);
		...
		a((Block) Blocks.YELLOW_FLOWER, (Item) (new ItemMultiTexture(Blocks.YELLOW_FLOWER, Blocks.YELLOW_FLOWER, new als())).b("flower"));
		a((Block) Blocks.RED_ROSE, (Item) (new ItemMultiTexture(Blocks.RED_ROSE, Blocks.RED_ROSE, new alt())).b("rose"));
		c((Block) Blocks.BROWN_MUSHROOM);
		c((Block) Blocks.RED_MUSHROOM);
		c(Blocks.GOLD_BLOCK);
		c(Blocks.IRON_BLOCK);
		a((Block) Blocks.STEP1, (Item) (new ItemStep(Blocks.STEP1, Blocks.STEP1, Blocks.DOUBLE_STEP1)).b("stoneSlab"));
		c(Blocks.BRICK);
		c(Blocks.TNT);
		c(Blocks.BOOKSHELF);
		...
		a(Blocks.MONSTER_EGGS, (Item) (new ItemMultiTexture(Blocks.MONSTER_EGGS, Blocks.MONSTER_EGGS, new alu())).b("monsterStoneEgg"));
		a(Blocks.SMOOTH_BRICK, (Item) (new ItemMultiTexture(Blocks.SMOOTH_BRICK, Blocks.SMOOTH_BRICK, new alv())).b("stonebricksmooth"));
		...
		a((Block) Blocks.WOOD_STEP, (Item) (new ItemStep(Blocks.WOOD_STEP, Blocks.WOOD_STEP, Blocks.WOOD_DOUBLE_STEP)).b("woodSlab"));
		...
		a(Blocks.COBBLE_WALL, (Item) (new ItemMultiTexture(Blocks.COBBLE_WALL, Blocks.COBBLE_WALL, new alw())).b("cobbleWall"));
		...
		a(Blocks.PRISMARINE, (Item) (new ItemMultiTexture(Blocks.PRISMARINE, Blocks.PRISMARINE, new aly())).b("prismarine"));
		c(Blocks.SEA_LANTERN);
		a(Blocks.RED_SANDSTONE, (Item) (new ItemMultiTexture(Blocks.RED_SANDSTONE, Blocks.RED_SANDSTONE, new alz())).b("redSandStone"));
		c(Blocks.RED_SANDSTONE_STAIRS);
		a((Block) Blocks.STEP2, (Item) (new ItemStep(Blocks.STEP2, Blocks.STEP2, Blocks.DOUBLE_STEP2)).b("stoneSlab2"));
		...
		a(295, "wheat_seeds", (new ItemSeeds(Blocks.CROPS, Blocks.SOIL)).c("seeds"));
		a(296, "wheat", (new Item()).c("wheat").a(CreativeModeTab.l));
		a(297, "bread", (new ItemFood(5, 0.6F, false)).c("bread"));
		a(298, "leather_helmet", (new ItemArmor(EnumArmorMaterial.CLOTH, 0, 0)).c("helmetCloth"));
		a(299, "leather_chestplate", (new ItemArmor(EnumArmorMaterial.CLOTH, 0, 1)).c("chestplateCloth"));
		a(300, "leather_leggings", (new ItemArmor(EnumArmorMaterial.CLOTH, 0, 2)).c("leggingsCloth"));
		a(301, "leather_boots", (new ItemArmor(EnumArmorMaterial.CLOTH, 0, 3)).c("bootsCloth"));
		...
		a(322, "golden_apple", (new ItemGoldenApple(4, 1.2F, false)).h().a(MobEffectList.l.H, 5, 1, 1.0F).c("appleGold"));
		...
		a(325, "bucket", var0);
		a(326, "water_bucket", (new ItemBucket(Blocks.WATER)).c("bucketWater").c(var0));
		a(327, "lava_bucket", (new ItemBucket(Blocks.LAVA)).c("bucketLava").c(var0));
		a(328, "minecart", (new ItemMinecart(EnumMinecartType.RIDEABLE)).c("minecart"));
		a(329, "saddle", (new ItemSaddle()).c("saddle"));
		a(330, "iron_door", (new ItemDoor(Blocks.IRON_DOOR_BLOCK)).c("doorIron"));
		...
		a(335, "milk_bucket", (new ItemMilkBucket()).c("milk").c(var0));
		...
		a(354, "cake", (new ItemReed(Blocks.CAKE_BLOCK)).c(1).c("cake").a(CreativeModeTab.h));
		...
		a(361, "pumpkin_seeds", (new ItemSeeds(Blocks.PUMPKIN_STEM, Blocks.SOIL)).c("seeds_pumpkin"));
		a(362, "melon_seeds", (new ItemSeeds(Blocks.MELON_STEM, Blocks.SOIL)).c("seeds_melon"));
		...
		a(391, "carrot", (new ItemSeedFood(3, 0.6F, Blocks.CARROTS, Blocks.SOIL)).c("carrots"));
		a(392, "potato", (new ItemSeedFood(1, 0.3F, Blocks.POTATOES, Blocks.SOIL)).c("potato"));
	...
	private static void c(Block var0) {
		a(var0, (Item) (new ItemBlock(var0)));
	}
