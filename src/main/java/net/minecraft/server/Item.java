...
public class Item {
   ...
   public static void t() {
      ...
      a(287, "string", (new ajv(Blocks.TRIPWIRE)).c("string").a(CreativeModeTab.l));
      ...
      a(338, "reeds", (new ajv(Blocks.SUGAR_CANE_BLOCK)).c("reeds").a(CreativeModeTab.l));
      ...
      a(354, "cake", (new ajv(Blocks.CAKE)).c(1).c("cake").a(CreativeModeTab.h));
      a(355, "bed", (new ajt()).c(1).c("bed"));
      a(356, "repeater", (new ajv(Blocks.DIODE_OFF)).c("diode").a(CreativeModeTab.d));
      ...
      a(379, "brewing_stand", (new ajv(Blocks.BREWING_STAND)).c("brewingStand").a(CreativeModeTab.k));
      a(380, "cauldron", (new ajv(Blocks.CAULDRON)).c("cauldron").a(CreativeModeTab.k));
      ...
      a(390, "flower_pot", (new ajv(Blocks.FLOWER_POT)).c("flowerPot").a(CreativeModeTab.c));
      ...
      a(404, "comparator", (new ajv(Blocks.REDSTONE_COMPARATOR_OFF)).c("comparator").a(CreativeModeTab.d));
