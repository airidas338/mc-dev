...
public class afy extends xn implements aex {
   ...
   public afy(World var1) {
      ...
      this.bg.a(3, new aam(this, acq.class));
   }
   ...
   public void s_() throws IOException {
      if(!this.o.D && this.o.aa() == EnumDifficulty.a && this.ck() > 0) {
         this.I = true;
      }
   ...
   public void i(Entity var1) {
      super.i(var1);
      if(var1 instanceof acq && this.cg()) {
         this.e((xm)var1);
      }

   }

   public void d(ahd var1) throws IOException {
      if(this.cg()) {
         this.e(var1);
      }
   ...
   protected void e(xm var1) {
      int var2 = this.ck();
      if(this.t(var1) && this.h(var1) < 0.6D * (double)var2 * 0.6D * (double)var2 && var1.a(wh.a((xm)this), (float)this.ch())) {
