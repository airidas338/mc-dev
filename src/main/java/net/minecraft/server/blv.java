...
public class blv extends bmk {
   ...
   private static final List a = Lists.newArrayList(new StructurePieceTreaasure[]{new StructurePieceTreaasure(Items.bu, 0, 1, 1, 10), new StructurePieceTreaasure(Items.DIAMOND, 0, 1, 3, 3), new StructurePieceTreaasure(Items.IRON_INGOT, 0, 1, 5, 10), new StructurePieceTreaasure(Items.GOLD_INGOT, 0, 1, 3, 5), new StructurePieceTreaasure(Items.aC, 0, 4, 9, 5), new StructurePieceTreaasure(Items.BREAD, 0, 1, 3, 15), new StructurePieceTreaasure(Items.APPLE, 0, 1, 3, 15), new StructurePieceTreaasure(Items.IRON_PICKAXE, 0, 1, 1, 5), new StructurePieceTreaasure(Items.IRON_SWORD, 0, 1, 1, 5), new StructurePieceTreaasure(Items.IRON_CHESTPLATE, 0, 1, 1, 5), new StructurePieceTreaasure(Items.IRON_HELMET, 0, 1, 1, 5), new StructurePieceTreaasure(Items.IRON_LEGGINGS, 0, 1, 1, 5), new StructurePieceTreaasure(Items.IRON_BOOTS, 0, 1, 1, 5), new StructurePieceTreaasure(Items.ao, 0, 1, 1, 1), new StructurePieceTreaasure(Items.aA, 0, 1, 1, 1), new StructurePieceTreaasure(Items.ck, 0, 1, 1, 1), new StructurePieceTreaasure(Items.cl, 0, 1, 1, 1), new StructurePieceTreaasure(Items.cm, 0, 1, 1, 1)});
   private boolean b;
