...
public class aop {
   ...
   private aop() {
      ...
      this.a(new ItemStack(Blocks.JUNGLE_FENCE, 3), new Object[]{"W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, ayx.d.a())});
      this.a(new ItemStack(Blocks.ACACIA_FENCE, 3), new Object[]{"W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, 4 + ayx.e.a() - 4)});
      this.a(new ItemStack(Blocks.DARK_OAK_FENCE, 3), new Object[]{"W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, 4 + ayx.f.a() - 4)});
      ...
      this.a(new ItemStack(Blocks.FENCE_GATE, 1), new Object[]{"#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, ayx.a.a())});
      this.a(new ItemStack(Blocks.BIRCH_FENCE_GATE, 1), new Object[]{"#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, ayx.c.a())});
      this.a(new ItemStack(Blocks.SPRUCE_FENCE_GATE, 1), new Object[]{"#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, ayx.b.a())});
      this.a(new ItemStack(Blocks.JUNGLE_FENCE_GATE, 1), new Object[]{"#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, ayx.d.a())});
      this.a(new ItemStack(Blocks.ACACIA_FENCE_GATE, 1), new Object[]{"#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, 4 + ayx.e.a() - 4)});
      this.a(new ItemStack(Blocks.DARK_OAK_FENCE_GATE, 1), new Object[]{"#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.WOOD, 1, 4 + ayx.f.a() - 4)});
      this.a(new ItemStack(Blocks.JUKEBOX, 1), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Blocks.WOOD, Character.valueOf('X'), Items.i});
      ...
      this.a(new ItemStack(Blocks.WOOL, 1), new Object[]{"##", "##", Character.valueOf('#'), Items.F});
      this.a(new ItemStack(Blocks.TNT, 1), new Object[]{"X#X", "#X#", "X#X", Character.valueOf('X'), Items.H, Character.valueOf('#'), Blocks.SAND});
      ...
      this.a(new ItemStack(Blocks.LADDER, 3), new Object[]{"# #", "###", "# #", Character.valueOf('#'), Items.y});
      ...
      this.a(new ItemStack(Blocks.TRAP_DOOR_IRON, 1), new Object[]{"##", "##", Character.valueOf('#'), Items.j});
      this.a(new ItemStack(Items.ap, 3), new Object[]{"###", "###", " X ", Character.valueOf('#'), Blocks.WOOD, Character.valueOf('X'), Items.y});
      ...
      this.a(new ItemStack(Items.y, 4), new Object[]{"#", "#", Character.valueOf('#'), Blocks.WOOD});
      this.a(new ItemStack(Blocks.TORCH, 4), new Object[]{"X", "#", Character.valueOf('X'), Items.h, Character.valueOf('#'), Items.y});
      this.a(new ItemStack(Blocks.TORCH, 4), new Object[]{"X", "#", Character.valueOf('X'), new ItemStack(Items.h, 1, 1), Character.valueOf('#'), Items.y});
      this.a(new ItemStack(Items.z, 4), new Object[]{"# #", " # ", Character.valueOf('#'), Blocks.WOOD});
      this.a(new ItemStack(Items.bA, 3), new Object[]{"# #", " # ", Character.valueOf('#'), Blocks.GLASS});
      this.a(new ItemStack(Blocks.RAILS, 16), new Object[]{"X X", "X#X", "X X", Character.valueOf('X'), Items.j, Character.valueOf('#'), Items.y});
      this.a(new ItemStack(Blocks.GOLDEN_RAIL, 6), new Object[]{"X X", "X#X", "XRX", Character.valueOf('X'), Items.k, Character.valueOf('R'), Items.aC, Character.valueOf('#'), Items.y});
      this.a(new ItemStack(Blocks.ACTIVATOR_RAIL, 6), new Object[]{"XSX", "X#X", "XSX", Character.valueOf('X'), Items.j, Character.valueOf('#'), Blocks.REDSTONE_TORCH_ON, Character.valueOf('S'), Items.y});
      this.a(new ItemStack(Blocks.DETECTOR_RAIL, 6), new Object[]{"X X", "X#X", "XRX", Character.valueOf('X'), Items.j, Character.valueOf('R'), Items.aC, Character.valueOf('#'), Blocks.STONE_PLATE});
      ...
      this.a(new ItemStack(Blocks.TRIPWIRE_HOOK, 2), new Object[]{"I", "S", "#", Character.valueOf('#'), Blocks.WOOD, Character.valueOf('S'), Items.y, Character.valueOf('I'), Items.j});
      this.a(new ItemStack(Blocks.REDSTONE_TORCH_ON, 1), new Object[]{"X", "#", Character.valueOf('#'), Items.y, Character.valueOf('X'), Items.aC});
      ...
      this.a(new ItemStack(Blocks.ENCHANTMENT_TABLE, 1), new Object[]{" B ", "D#D", "###", Character.valueOf('#'), Blocks.OBSIDIAN, Character.valueOf('B'), Items.aL, Character.valueOf('D'), Items.i});
      this.a(new ItemStack(Blocks.ANVIL, 1), new Object[]{"III", " i ", "iii", Character.valueOf('I'), Blocks.IRON_BLOCK, Character.valueOf('i'), Items.j});
      ...
      this.a(new ItemStack(Blocks.HOPPER), new Object[]{"I I", "ICI", " I ", Character.valueOf('I'), Items.j, Character.valueOf('C'), Blocks.CHEST});
      this.a(new ItemStack(Items.cj, 1), new Object[]{"///", " / ", "/_/", Character.valueOf('/'), Items.y, Character.valueOf('_'), new ItemStack(Blocks.STEP1, 1, bbg.a.a())});
