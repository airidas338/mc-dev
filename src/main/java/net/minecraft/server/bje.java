...
public class bje {
   ...
   private static final List a = Lists.newArrayList(new StructurePieceTreaasure[]{new StructurePieceTreaasure(Items.IRON_INGOT, 0, 1, 5, 10), new StructurePieceTreaasure(Items.GOLD_INGOT, 0, 1, 3, 5), new StructurePieceTreaasure(Items.aC, 0, 4, 9, 5), new StructurePieceTreaasure(Items.aW, akv.l.b(), 4, 9, 5), new StructurePieceTreaasure(Items.DIAMOND, 0, 1, 2, 3), new StructurePieceTreaasure(Items.COAL, 0, 3, 8, 10), new StructurePieceTreaasure(Items.BREAD, 0, 1, 3, 15), new StructurePieceTreaasure(Items.IRON_PICKAXE, 0, 1, 1, 1), new StructurePieceTreaasure(Item.getItemOf(Blocks.RAILS), 0, 4, 8, 1), new StructurePieceTreaasure(Items.bh, 0, 2, 4, 10), new StructurePieceTreaasure(Items.bg, 0, 2, 4, 10), new StructurePieceTreaasure(Items.aA, 0, 1, 1, 3), new StructurePieceTreaasure(Items.ck, 0, 1, 1, 1)});
