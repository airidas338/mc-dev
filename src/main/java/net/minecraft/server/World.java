...
public abstract class World implements IBlockAccess {
	...
	public BiomeBase b(Location var1) {
		if (this.e(var1)) {
			Chunk var2 = this.f(var1);

			try {
				return var2.getBiome(var1, this.t.m()); //TODO: Rename to getBiome
	...
	public Block c(Location var1) {
		Location var2;
		for (var2 = new Location(var1.n(), 63, var1.p()); !this.d(var2.a()); var2 = var2.a()) {
			;
		}
	...
	public boolean e(Location var1) {
		return this.a(var1, true);
	}

	public boolean a(Location var1, boolean var2) {
	...
	protected boolean a(int var1, int var2, boolean var3) {
		return this.v.isChunkLoaded(var1, var2) && (var3 || !this.v.getOrCreateChunk(var1, var2).f());
	}
	...
	public Chunk getChunkAt(int var1, int var2) {
		return this.v.getOrCreateChunk(var1, var2);
	}

	public boolean a(Location var1, IBlock var2, int var3) {
		if (!this.a(var1)) {
			return false;
	...
	public boolean a(Location var1, IBlock var2) {
	...
	public MovingObjectPosition a(Vec3D var1, Vec3D var2, boolean var3, boolean var4, boolean var5) {
		if (!Double.isNaN(var1.a) && !Double.isNaN(var1.b) && !Double.isNaN(var1.c)) {
			if (!Double.isNaN(var2.a) && !Double.isNaN(var2.b) && !Double.isNaN(var2.c)) {
				...
				IBlock var14 = this.getData(var12);
				Block var15 = var14.c();
				...
				while (var41-- >= 0) {
					...
					var9 = MathHelper.c(var1.a) - (var37 == EnumFacing.EAST ? 1 : 0);
					var10 = MathHelper.c(var1.b) - (var37 == EnumFacing.UP ? 1 : 0);
					var11 = MathHelper.c(var1.c) - (var37 == EnumFacing.SOUTH ? 1 : 0);
					var12 = new Location(var9, var10, var11);
					IBlock var38 = this.getData(var12);
					Block var39 = var38.c();
	...
	public List a(Entity var1, AxisAlignedBB var2) {
		...
		for (int var10 = var4; var10 < var5; ++var10) {
			for (int var11 = var8; var11 < var9; ++var11) {
				if (this.e(new Location(var10, 64, var11))) {
	...
	public List a(AxisAlignedBB var1) {
		...
		for (int var9 = var3; var9 < var4; ++var9) {
			for (int var10 = var7; var10 < var8; ++var10) {
				if (this.e(new Location(var9, 64, var10))) {
	...
	public float c(float var1) {
		return this.t.a(this.x.getDayTime(), var1);
	}

	public float y() {
		return WorldProvider.a[this.t.a(this.x.getDayTime())];
	}
			...
			for (int var12 = var4; var12 < var5; ++var12) {
				for (int var13 = var6; var13 < var7; ++var13) {
					for (int var14 = var8; var14 < var9; ++var14) {
						...
						IBlock var16 = this.getData(var15);
						Block var17 = var16.c();
						if (var17.r() == var2) {
	...
	public boolean b(AxisAlignedBB var1, Material var2) {
		...
		for (int var9 = var3; var9 < var4; ++var9) {
			for (int var10 = var5; var10 < var6; ++var10) {
				for (int var11 = var7; var11 < var8; ++var11) {
					Location var12 = new Location(var9, var10, var11);
					IBlock var13 = this.getData(var12);
					Block var14 = var13.c();
					if (var14.r() == var2) {
	...
	protected void p() {
		if (!this.t.o()) {
			if (!this.D) {
				int var1 = this.x.getThunderDuration();
				if (var1 > 0) {
					--var1;
					this.x.i(var1);
	...
	protected void a(int var1, int var2, Chunk var3) {
		...
		if (this.K == 0 && !this.D) {
			...
			var5 += var1;
			var6 += var2;
			if (var9.r() == Material.AIR && this.k(var8) <= this.s.nextInt(8) && this.b(EnumSkyBlock.SKY, var8) <= 0) {
	...
	public boolean z(Location var1) {
		return this.c(var1.b(), EnumFacing.DOWN) > 0 ? true : (this.c(var1.a(), EnumFacing.UP) > 0 ? true : (this.c(var1.c(), EnumFacing.NORTH) > 0 ? true : (this.c(var1.d(), EnumFacing.SOUTH) > 0 ? true : (this.c(var1.e(), EnumFacing.WEST) > 0 ? true
				: this.c(var1.f(), EnumFacing.EAST) > 0))));
	}
	...
	public Location M() {
		Location var1 = new Location(this.x.c(), this.x.d(), this.x.e());
		if (!this.af().a(var1)) {
