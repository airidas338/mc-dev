...
public class qk extends qx {
   ...
   public void a() {
      ...
      if(var1 % 24000L == 500L) {
         if(var3 <= 6L) {
            this.b.a((IChatBaseComponent)(new hz("demo.day." + var3, new Object[0])));
         }
      } else if(var3 == 1L) {
         if(var1 == 100L) {
         ...
         this.b.a((IChatBaseComponent)(new hz("demo.day.warning", new Object[0])));
      }
   ...
   private void f() {
      if(this.e > 100) {
         this.b.a((IChatBaseComponent)(new hz("demo.reminder", new Object[0])));
         this.e = 0;
      }
