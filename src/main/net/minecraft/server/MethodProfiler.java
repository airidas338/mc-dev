...
public class MethodProfiler {
   ...
   public List b(String var1) {
      if(!this.a) {
         ...
         Iterator var20 = this.f.keySet().iterator();
         ...
         while(var20.hasNext()) {
            ...
            if(var12.length() > var1.length() && var12.startsWith(var1) && var12.indexOf(".", var1.length() + 1) < 0) {
               ...
               var7.add(new ux(var19, var15, var17));
            }
         }

         var20 = this.f.keySet().iterator();
         ...
         if((float)var8 > var21) {
            var7.add(new ux("unspecified", (double)((float)var8 - var21) * 100.0D / (double)var8, (double)((float)var8 - var21) * 100.0D / (double)var3));
         }

         Collections.sort(var7);
         var7.add(0, new ux(var1, 100.0D, (double)var8 * 100.0D / (double)var3));
         return var7;
      }
   }
