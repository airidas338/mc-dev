...
public class asc extends WorldChunkManager {

   private BiomeBase b;
   private float c;


   public asc(BiomeBase var1, float var2) {
      this.b = var1;
      this.c = var2;
   }

   public BiomeBase a(Location var1) {
      return this.b;
   }
   ...
   public Location a(int var1, int var2, int var3, List var4, Random var5) {
      return var4.contains(this.b)?new Location(var1 - var3 + var5.nextInt(var3 * 2 + 1), 0, var2 - var3 + var5.nextInt(var3 * 2 + 1)):null;
   }
