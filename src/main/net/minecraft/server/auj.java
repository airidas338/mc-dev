...
public class auj extends atg {
   ...
   public IBlock e(World var1, Location var2, IBlock var3) {
      if(var1.D) {
         ...
         IBlock var4 = var1.p(var2.c());
         IBlock var5 = var1.p(var2.d());
         IBlock var6 = var1.p(var2.e());
         IBlock var7 = var1.p(var2.f());
         ej var8 = (ej)var3.b(a);
         Block var9 = var4.c();
         Block var10 = var5.c();
         Block var11 = var6.c();
         ...
         if(var9 != this && var10 != this) {
            ...
            if(var11 == this || var12 == this) {
               ...
               IBlock var25 = var1.p(var22.c());
               IBlock var24 = var1.p(var22.d());
               var8 = ej.d;
               ej var26;
               if(var11 == this) {
                  var26 = (ej)var6.b(a);
            ...
            IBlock var14 = var1.p(var13.e());
            IBlock var15 = var1.p(var13.f());
            var8 = ej.f;
            ej var16;
            if(var9 == this) {
               var16 = (ej)var4.b(a);
   ...
   public IBlock f(World var1, Location var2, IBlock var3) {
      ...
      while(var5.hasNext()) {
         ...
         IBlock var7 = var1.p(var2.a(var6));
         if(var7.c() == this) {
            return var3;
         }
