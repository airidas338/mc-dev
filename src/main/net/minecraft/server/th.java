   ...
   public void run() {
      while(true) {
         try {
            ...
            byte var3 = 0;
            int var4 = tb.b(this.k, 0, var2);
            if(var4 == var2 - 4) {
               int var21 = var3 + 4;
               int var5 = tb.b(this.k, var21, var2);
               var21 += 4;
               int var6 = tb.b(this.k, var21);
               var21 += 4;
               switch(var6) {
               case 2:
                  if(this.i) {
                     String var8 = tb.a(this.k, var21, var2);

                     try {
                        this.a(var5, this.b.g(var8));
                  ...
                  continue;
               case 3:
                  String var7 = tb.a(this.k, var21, var2);
                  int var10000 = var21 + var7.length();
                  if(0 != var7.length() && var7.equals(this.l)) {
                     this.i = true;
                     this.a(var5, 2, "");
                     continue;
                  }
