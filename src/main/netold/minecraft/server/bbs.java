...
public class bbs extends atr {
   ...
   public void a(aqu var1, dt var2, bec var3, atr var4) {
      ...
      boolean var6 = !aqu.a((ard)var1, var2.b());
      if(var5 != var6) {
   ...
   public void c(aqu var1, dt var2, bec var3) {
      var3 = var3.a(b, Boolean.valueOf(!aqu.a((ard)var1, var2.b())));
      var1.a(var2, var3, 3);
   ...
   private void e(aqu var1, dt var2, bec var3) {
   ...
   private void d(aqu var1, dt var2) {
      ...
      boolean var5 = false;
      List var6 = var1.b((wv)null, new brt((double)var2.n() + this.B, (double)var2.o() + this.C, (double)var2.p() + this.D, (double)var2.n() + this.E, (double)var2.o() + this.F, (double)var2.p() + this.G));
      if(!var6.isEmpty()) {
         Iterator var7 = var6.iterator();

         while(var7.hasNext()) {
            wv var8 = (wv)var7.next();
            if(!var8.aH()) {
               var5 = true;
               break;
            }
