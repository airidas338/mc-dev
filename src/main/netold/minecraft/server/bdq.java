...
public class bdq extends atr {
   ...
   public static ej a(aqu var0, dt var1, xm var2) {
   ...
   public static boolean a(atr var0, aqu var1, dt var2, ej var3, boolean var4) {
      if(var0 == aty.Z) {
         return false;
   ...
   private boolean a(aqu var1, dt var2, ej var3, boolean var4) {
      if(!var4) {
         var1.g(var2.a(var3));
      }
      ...
      if(!var5.a()) {
         ...
         for(var11 = var6.size() - 1; var11 >= 0; --var11) {
            ...
            var1.a(var12, bdx.a(var19, var3, var4, false));
            --var8;
            var9[var8] = var14;
         }
