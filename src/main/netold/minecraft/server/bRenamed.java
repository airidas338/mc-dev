...
public class bRenamed {
   ...
   public bRenamed(String var1, Throwable var2) {
      this.b = var1;
      this.c = var2;
      this.h();
   }
   ...
   public void a(StringBuilder var1) {
      if((this.h == null || this.h.length <= 0) && this.e.size() > 0) {
         this.h = (StackTraceElement[])ArrayUtils.subarray(((j)this.e.get(0)).a(), 0, 1);
      }
   ...
   public static bRenamed a(Throwable var0, String var1) {
      bRenamed var2;
      if(var0 instanceof u) {
         var2 = ((u)var0).a();
      } else {
         var2 = new bRenamed(var1, var0);
      }
