...
public class adu extends wv {
   ...
   public adu(aqu var1, double var2, double var4, double var6) {
      this(var1);
   ...
   public void s_() {
      ...
      if(this.o.D && this.a) {
         ...
         this.b(this.y, this.z);
         if(!this.o.D) {
            List var16 = this.o.B((wv)this, this.aQ().b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
            if(var16 != null && !var16.isEmpty()) {
               for(int var29 = 0; var29 < var16.size(); ++var29) {
                  wv var18 = (wv)var16.get(var29);
                  if(var18 != this.l && var18.ae() && var18 instanceof adu) {
                     var18.i(this);
                  }
               }
            }
