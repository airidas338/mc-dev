...
public class aph {
	...
	public static void a(xm var0, wv var1) {
		d.b = var1;
		d.a = var0;
		if (var0 != null) {
			a((apl) d, var0.at());
	...
	public static void b(xm var0, wv var1) {
		e.a = var0;
		e.b = var1;
		if (var0 != null) {
			a((apl) e, var0.at());
	...
	public static int a(xm var0) {
		return a(apf.o.B, var0.bz());
	}

	public static int b(xm var0) {
	...
	public static int b(wv var0) {
		return a(apf.k.B, var0.at());
	}

	public static int c(xm var0) {
		return a(apf.r.B, var0.bz());
	}

	public static boolean e(xm var0) {
		return a(apf.s.B, var0.bz()) > 0;
	}

	public static int f(xm var0) {
		return a(apf.u.B, var0.bz());
	}

	public static int g(xm var0) {
		return a(apf.z.B, var0.bz());
	}

	public static int h(xm var0) {
		return a(apf.o.B, var0.bz());
	}

	public static int i(xm var0) {
		return a(apf.q.B, var0.bz());
	}

	public static boolean j(xm var0) {
		return a(apf.i.B, var0.at()) > 0;
	}

	public static amj a(apf var0, xm var1) {
		amj[] var2 = var1.at();
