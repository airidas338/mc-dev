...
public abstract class z implements ac {
   ...
   public static qw b(ae var0) throws dm {
   ...
   public static qw a(ae var0, String var1) throws dm {
   ...
   public static wv b(ae var0, String var1) throws dj {
      return a(var0, var1, wv.class);
   }

   public static wv a(ae var0, String var1, Class var2) throws dj {
   ...
   public static List c(ae var0, String var1) throws dj {
      return (List)(ah.b(var1)?ah.b(var0, var1, wv.class):Lists.newArrayList(new wv[]{b(var0, var1)}));
   }
   ...
   public static ho a(ae var0, String[] var1, int var2) throws dm {
      return b(var0, var1, var2, false);
   }

   public static ho b(ae var0, String[] var1, int var2, boolean var3) throws dm {
      hy var4 = new hy("");
