...
public class ah {
   ...
   public static qw a(ae var0, String var1) {
      return (qw)a(var0, var1, qw.class);
   }

   public static wv a(ae var0, String var1, Class var2) {
      List var3 = b(var0, var1, var2);
      return var3.size() == 1?(wv)var3.get(0):null;
   }

   public static ho b(ae var0, String var1) {
      List var2 = b(var0, var1, wv.class);
      if(var2.isEmpty()) {
         return null;
      } else {
         ...
         return z.a((List)var3);
      }
   }

   public static List b(ae var0, String var1, Class var2) {
   ...
   private static List a(ae var0, Map var1) {
   ...
   private static List a(Map var0, Class var1, List var2, String var3, aqu var4, dt var5) {
   ...
   private static List a(List var0, Map var1, ae var2, Class var3, String var4, dt var5) {
      ...
      if(var7 != null && var3.isAssignableFrom(var7.getClass()) && var6 == 1 && ((List)var0).contains(var7) && !"r".equals(var4)) {
         var0 = Lists.newArrayList(new wv[]{var7});
      }
   ...
   private static brt a(dt var0, int var1, int var2, int var3) {
      boolean var4 = var1 < 0;
      boolean var5 = var2 < 0;
      boolean var6 = var3 < 0;
