...
public abstract class aqu implements ard {
   ...
   public arm b(dt var1) {
      if(this.e(var1)) {
         ...
         try {
            ...
            bRenamed var4 = bRenamed.a(var6, "Getting biome");
   ...
   public void d(dt var1, atr var2) {
      if(!this.D) {
         ...
         try {
            ...
            bRenamed var5 = bRenamed.a(var7, "Exception while updating neighbours");
   ...
   public void i() {
      ...
      for(var1 = 0; var1 < this.k.size(); ++var1) {
         ...
         try {
            ...
            var4 = bRenamed.a(var9, "Ticking entity");
      ...
      for(var1 = 0; var1 < this.f.size(); ++var1) {
         ...
         if(!var2.I) {
            try {
               ...
               var4 = bRenamed.a(var8, "Ticking entity");
               var5 = var4.a("Entity being ticked");
               var2.a(var5);
               throw new u(var4);
            }
         ...
         if(!var10.x() && var10.t()) {
            ...
            if(this.e(var12) && this.M.a(var12)) {
               try {
                  ...
                  bRenamed var16 = bRenamed.a(var7, "Ticking block entity");
   ...
   public void a(ahd var1, int var2, dt var3, int var4) {
      try {
         ...
         bRenamed var6 = bRenamed.a(var8, "Playing level event");
