...
public abstract class MinecraftServer implements ae, Runnable, vn, wd {
   ...
   private final bra l;
   private final wb m = new wb("server", this, ax());
   ...
   protected void a(String var1, String var2, long var3, are var5, String var6) {
      ...
      for(int var10 = 0; var10 < this.c.length; ++var10) {
         ...
         if(var10 == 0) {
            if(this.W()) {
               this.c[var10] = (qt)(new qj(this, var7, var9, var11, this.b)).b();
            } else {
               this.c[var10] = (qt)(new qt(this, var7, var9, var11, this.b)).b();
            }

            this.c[var10].a(var8);
         } else {
            this.c[var10] = (qt)(new ql(this, var7, var11, this.c[0], this.b)).b();
         }

         this.c[var10].a((ara)(new qp(this, this.c[var10])));
         if(!this.S()) {
   ...
   public void run() {
      try {
         if(this.i()) {
            ...
            while(this.w) {
               ...
               if(var5 > 2000L && this.ab - this.R >= 15000L) {
                  j.warn("Can\'t keep up! Did the system time change, or is the server overloaded? Running {}ms behind, skipping {} tick(s)", new Object[]{Long.valueOf(var5), Long.valueOf(var5 / 50L)});
                  var5 = 2000L;
                  this.R = this.ab;
               }
         ...
         if(var46 instanceof u) {
            ...
            var2 = this.b(new bRenamed("Exception in server tick loop", var46));
         }
   ...
   protected void a(bRenamed var1) {}
   ...
   protected void y() {
      ...
      if(var1 - this.X >= 5000000000L) {
         ...
         int var4 = uv.a(this.s, 0, this.G() - var3.length);

         for(int var5 = 0; var5 < var3.length; ++var5) {
            var3[var5] = ((qw)this.v.e.get(var4 + var5)).cc();
         }
   ...
   public void z() {
      ...
      for(var11 = 0; var11 < this.c.length; ++var11) {
         ...
         if(var11 == 0 || this.A()) {
            qt var4 = this.c[var11];
            this.b.a(var4.P().k());
            if(this.y % 20 == 0) {
               this.b.a("timeSync");
               this.v.a((id)(new li(var4.K(), var4.L(), var4.Q().b("doDaylightCycle"))), var4.t.q());
               this.b.b();
            }
   ...
   public static void main(String[] var0) {
      ...
      try {
         ...
         var15.B();
         Runtime.getRuntime().addShutdownHook(new pe("Server Shutdown Thread", var15));
   ...
   public bRenamed b(bRenamed var1) {
   ...
   // $FF: synthetic method
   public static sn a(MinecraftServer var0) {
      return var0.v;
   }
