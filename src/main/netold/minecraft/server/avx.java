...
public class avx extends atr {
   ...
   public bec a(bec var1, ard var2, dt var3) {
      ...
      int var5 = var3.o();
      int var6 = var3.p();
      if(!aqu.a(var2, var3.b()) && !aty.ab.e(var2, var3.b())) {
   ...
   public void b(aqu var1, dt var2, bec var3, Random var4) {
      if(var1.Q().b("doFireTick")) {
         ...
         if(!var6 && var1.S() && this.d(var1, var2)) {
            ...
            if(!var6) {
               if(!this.e(var1, var2)) {
                  if(!aqu.a((ard)var1, var2.b()) || var7 > 3) {
                     var1.g(var2);
                  }
   ...
   protected boolean d(aqu var1, dt var2) {
   ...
   private void a(aqu var1, dt var2, int var3, Random var4, int var5) {
      ...
      if(var4.nextInt(var3) < var6) {
         ...
         if(var7.c() == aty.W) {
            aty.W.d(var1, var2, var7.a(bbk.a, Boolean.valueOf(true)));
         }
      }
   ...
   private int m(aqu var1, dt var2) {
      if(!var1.d(var2)) {
         return 0;
      } else {
         int var3 = 0;
   ...
   public boolean c(aqu var1, dt var2) {
      return aqu.a((ard)var1, var2.b()) || this.e(var1, var2);
   }

   public void a(aqu var1, dt var2, bec var3, atr var4) {
      if(!aqu.a((ard)var1, var2.b()) && !this.e(var1, var2)) {
         var1.g(var2);
      }
