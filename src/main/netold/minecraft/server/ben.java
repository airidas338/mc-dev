...
public class ben {
   ...
   public ben a(char var1, Predicate var2) {
      this.c.put(Character.valueOf(var1), var2);
      return this;
   }

   public bek b() {
      return new bek(this.c());
   }
   ...
   private void d() {
      ...
      if(!var1.isEmpty()) {
         throw new IllegalStateException("Predicates for character(s) " + aRenamed.join(var1) + " are missing");
      }
   }
