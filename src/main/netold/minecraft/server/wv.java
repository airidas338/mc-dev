...
public abstract class wv implements ae {
   ...
   public void d(double var1, double var3, double var5) {
      if(this.T) {
         ...
         int var58 = uv.c(this.s);
         int var59 = uv.c(this.t - 0.20000000298023224D);
         int var56 = uv.c(this.u);
         ...
         if(this.r_() && !var19 && this.m == null) {
            ...
            this.N = (float)((double)this.N + (double)uv.a(var61 * var61 + var63 * var63 + var66 * var66) * 0.6D);
         ...
         try {
            ...
            bRenamed var65 = bRenamed.a(var52, "Checking entity block collision");
            j var64 = var65.a("Entity being checked for collision");
            this.a(var64);
            throw new u(var65);
         }
            ...
            for(int var4 = var1.o(); var4 <= var2.o(); ++var4) {
               for(int var5 = var1.p(); var5 <= var2.p(); ++var5) {
                  ...
                  try {
                     ...
                     bRenamed var9 = bRenamed.a(var11, "Colliding entity with block");
   ...
   public void e(fn var1) {
      try {
         ...
         bRenamed var3 = bRenamed.a(var5, "Saving entity NBT");
   ...
   public void f(fn var1) {
      try {
         ...
         bRenamed var3 = bRenamed.a(var5, "Loading entity NBT");
