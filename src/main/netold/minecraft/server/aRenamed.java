...
public enum aRenamed {
   ...
   private final int C;
   // $FF: synthetic field
   private static final aRenamed[] D = new aRenamed[]{a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v};
   ...
   private aRenamed(String var1, int var2, String var3, char var4, int var5) {
      this(var1, var2, var3, var4, false, var5);
   }

   private aRenamed(String var1, int var2, String var3, char var4, boolean var5) {
      this(var1, var2, var3, var4, var5, -1);
   }

   private aRenamed(String var1, int var2, String var3, char var4, boolean var5, int var6) {
      this.y = var3;
      this.z = var4;
      this.A = var5;
      this.C = var6;
   ...
   public static aRenamed b(String var0) {
      return var0 == null?null:(aRenamed)w.get(c(var0));
   }

   public static aRenamed a(int var0) {
      if(var0 < 0) {
         return v;
      } else {
         aRenamed[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            aRenamed var4 = var1[var3];
            if(var4.b() == var0) {
               return var4;
            }
         }
   ...
   public static Collection a(boolean var0, boolean var1) {
      ...
      aRenamed[] var3 = values();
      int var4 = var3.length;

      for(int var5 = 0; var5 < var4; ++var5) {
         aRenamed var6 = var3[var5];
   ...
   static {
      aRenamed[] var0 = values();
      int var1 = var0.length;

      for(int var2 = 0; var2 < var1; ++var2) {
         aRenamed var3 = var0[var2];
         w.put(c(var3.y), var3);
      }
