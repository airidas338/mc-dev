...
public class acb extends abq {
   ...
   public boolean r(wv var1) {
      if(this.cl() == 99) {
         ...
         return var1.a(wh.a((xm)this), 8.0F);
      } else {
   ...
   public acb b(ws var1) {
      acb var2 = new acb(this.o);
      if(var1 instanceof acb) {
         var2.r(this.V.nextBoolean()?this.cl():((acb)var1).cl());
      }
