...
public abstract class ahl extends wv {
   ...
   public ahl(aqu var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      super(var1);
      this.a(1.0F, 1.0F);
      this.b(var2, var4, var6, this.y, this.z);
      this.b(var2, var4, var6);
      double var14 = (double)uv.a(var8 * var8 + var10 * var10 + var12 * var12);
      this.b = var8 / var14 * 0.1D;
      this.c = var10 / var14 * 0.1D;
      this.d = var12 / var14 * 0.1D;
   }

   public ahl(aqu var1, xm var2, double var3, double var5, double var7) {
      super(var1);
      this.a = var2;
      this.a(1.0F, 1.0F);
   ...
   public void s_() {
      if(!this.o.D && (this.a != null && this.a.I || !this.o.e(new dt(this)))) {
         ...
         this.t += this.w;
         this.u += this.x;
         float var15 = uv.a(this.v * this.v + this.x * this.x);
