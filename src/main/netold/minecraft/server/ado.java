...
public class ado extends wv {
   ...
   public void s_() {
      ...
      if(this.ax > 0) {
         ...
         if(var3 != null) {
            if(var3.d != null) {
               if(var3.d.a(wh.a((wv)this, this.b), 0.0F)) {
                  this.c = var3.d;
               }
            } else {
               this.aq = true;
   ...
   public int l() {
      if(this.o.D) {
         ...
         if(this.c != null) {
            ...
            var13.x = var7 * var11;
            this.o.d((wv)var13);
            this.b.o.d((wv)(new xk(this.b.o, this.b.s, this.b.t + 0.5D, this.b.u + 0.5D, this.V.nextInt(6) + 1)));
            var1 = 1;
         }
