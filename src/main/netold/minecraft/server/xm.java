...
public abstract class xm extends wv {
   ...
   protected void a(double var1, boolean var3, atr var4, dt var5) {
      ...
      if(!this.o.D && this.O > 3.0F && var3) {
         ...
         if(var7.r() != bof.a) {
            ...
            ((qt)this.o).a(ew.M, this.s, this.t, this.u, var11, 0.0D, 0.0D, 0.0D, 0.15000000596046448D, new int[]{atr.f(var6)});
         }
      }
   ...
   public void K() {
      ...
      boolean var1 = this instanceof ahd;
      if(this.ai()) {
         if(this.aj()) {
            this.a(wh.e, 1.0F);
         } else if(var1 && !this.o.af().a(this.aQ())) {
            double var2 = this.o.af().a((wv)this) + this.o.af().m();
            if(var2 < 0.0D) {
      ...
      if(this.ai() && this.a(bof.h)) {
         ...
         if(!this.o.D && this.av() && this.m instanceof xm) {
            this.a((wv)null);
         }
      } else {
         this.h(300);
      ...
      if(this.av == 20) {
         ...
         if(!this.o.D && (this.aM > 0 || this.ba()) && this.aZ() && this.o.Q().b("doMobLoot")) {
            ...
            while(var1 > 0) {
               int var2 = xk.a(var1);
               var1 -= var2;
               this.o.d((wv)(new xk(this.o, this.s, this.t, this.u, var2)));
            }
         }
   ...
   public void b(fn var1) {
      ...
      var1.a("Attributes", (gd)afs.a(this.bx()));
      var2 = this.at();
      var3 = var2.length;
   ...
   protected void a(wq var1) {
      this.i = true;
      if(!this.o.D) {
         wp.a[var1.a()].b(this, this.bx(), var1.c());
      }
   ...
   protected void a(wq var1, boolean var2) {
      this.i = true;
      if(var2 && !this.o.D) {
         wp.a[var1.a()].a(this, this.bx(), var1.c());
         wp.a[var1.a()].b(this, this.bx(), var1.c());
      }
   ...
   public boolean a(wh var1, float var2) {
      if(this.b(var1)) {
         ...
         if(this.bm() <= 0.0F) {
            ...
            if((var1 == wh.n || var1 == wh.o) && this.p(4) != null) {
   ...
   public void a(wh var1) {
      ...
      this.o.a((wv)this, (byte)3);
   }

   protected void a(boolean var1, int var2) {}

   public void a(wv var1, float var2, double var3, double var5) {
   ...
   protected float b(wh var1, float var2) {
      if(!var1.e()) {
         int var3 = 25 - this.bq();
   ...
   public xm bs() {
      return (xm)(this.f.c() != null?this.f.c():(this.aL != null?this.aL:(this.bg != null?this.bg:null)));
   }
   ...
   public void bv() {
      if(!this.ap || this.aq >= this.n() / 2 || this.aq < 0) {
         ...
         if(this.o instanceof qt) {
            ((qt)this.o).s().a((wv)this, (id)(new ir(this, 0)));
         }
      }
      ...
      for(int var10 = -var9; var10 <= var9; ++var10) {
         for(int var11 = -var9; var11 < var9; ++var11) {
            if(var10 != 0 || var11 != 0) {
               ...
               brt var2 = this.aQ().c((double)var10, 1.0D, (double)var11);
               if(this.o.a(var2).isEmpty()) {
                  if(aqu.a((ard)this.o, new dt(var12, (int)this.t, var13))) {
                     this.a(this.s + (double)var10, this.t + 1.0D, this.u + (double)var11);
                     return;
                  }

                  if(aqu.a((ard)this.o, new dt(var12, (int)this.t - 1, var13)) || this.o.p(new dt(var12, (int)this.t - 1, var13)).c().r() == bof.h) {
   ...
   public void g(float var1, float var2) {
      ...
      if(this.bL()) {
         ...
         if(this.V() && (!(this instanceof ahd) || !((ahd)this).by.b)) {
            ...
            if(this.j_()) {
               ...
               boolean var7 = this.aw() && this instanceof ahd;
               if(var7 && this.w < 0.0D) {
                  this.w = 0.0D;
               }
            }
      ...
      var9 = uv.a(var8 * var8 + var10 * var10) * 4.0F;
      if(var9 > 1.0F) {
         var9 = 1.0F;
      }
   ...
   public void s_() {
      ...
      if(!this.o.D) {
         ...
         for(int var2 = 0; var2 < 5; ++var2) {
            ...
            if(!amj.b(var4, var3)) {
               ((qt)this.o).s().a((wv)this, (id)(new la(this.F(), var2, var4)));
               if(var3 != null) {
                  this.c.a(var3.B());
               }
   ...
   protected void bK() {
      List var1 = this.o.B((wv)this, this.aQ().b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
   ...
   public boolean t(wv var1) {
      return this.o.a(new brw(this.s, this.t + (double)this.aR(), this.u), new brw(var1.s, var1.t + (double)var1.aR(), var1.u)) == null;
   }
   ...
   protected void ac() {
      this.G = this.V.nextDouble() >= this.a(afs.c).e();
   }
