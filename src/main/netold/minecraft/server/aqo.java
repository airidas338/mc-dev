...
public class aqo {
   ...
   public aqo(aqu var1, wv var2, double var3, double var5, double var7, float var9, boolean var10, boolean var11) {
      this.d = var1;
      this.h = var2;
      this.i = var9;
      this.e = var3;
   ...
   public void a() {
            ...
            for(var5 = 0; var5 < 16; ++var5) {
               if(var3 == 0 || var3 == 15 || var4 == 0 || var4 == 15 || var5 == 0 || var5 == 15) {
                  ...
                  for(float var21 = 0.3F; var14 > 0.0F; var14 -= 0.22500001F) {
                     ...
                     if(var23.c().r() != bof.a) {
                        float var24 = this.h != null?this.h.a(this, this.d, var22, var23):var23.c().a((wv)null);
      ...
      var4 = uv.c(this.e - (double)var30 - 1.0D);
      var5 = uv.c(this.e + (double)var30 + 1.0D);
      int var31 = uv.c(this.f - (double)var30 - 1.0D);
      int var7 = uv.c(this.f + (double)var30 + 1.0D);
      int var32 = uv.c(this.g - (double)var30 - 1.0D);
      int var9 = uv.c(this.g + (double)var30 + 1.0D);
      ...
      for(int var34 = 0; var34 < var33.size(); ++var34) {
         ...
         if(!var13.aV()) {
            ...
            if(var35 <= 1.0D) {
               ...
               double var36 = (double)uv.a(var16 * var16 + var18 * var18 + var20 * var20);
               if(var36 != 0.0D) {
                  var16 /= var36;
                  var18 /= var36;
                  var20 /= var36;
                  ...
                  if(var13 instanceof ahd) {
                     this.k.put((ahd)var13, new brw(var16 * var26, var18 * var26, var20 * var26));
                  }
               }
            }
         }
      ...
      if(this.b) {
         ...
         while(var2.hasNext()) {
            ...
            if(var1) {
               ...
               double var17 = (double)uv.a(var11 * var11 + var13 * var13 + var15 * var15);
               var11 /= var17;
               var13 /= var17;
               var15 /= var17;
