...
public class pt implements Runnable {
   ...
   public void run() {
      while(this.b.t()) {
         ...
         long var5 = var3 - var1;
         if(var5 > this.c) {
            aRenamed.fatal("A single server tick took " + String.format("%.2f", new Object[]{Float.valueOf((float)var5 / 1000.0F)}) + " seconds (should be max " + String.format("%.2f", new Object[]{Float.valueOf(0.05F)}) + ")");
            aRenamed.fatal("Considering it to be crashed, server will forcibly shutdown.");
            ...
            bRenamed var16 = new bRenamed("Watching Server", var10);
            this.b.b(var16);
