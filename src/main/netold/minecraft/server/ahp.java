...
public class ahp extends ahl {
   ...
   public ahp(aqu var1, xm var2, double var3, double var5, double var7) {
      super(var1, var2, var3, var5, var7);
      this.a(0.3125F, 0.3125F);
   }

   public ahp(aqu var1, double var2, double var4, double var6, double var8, double var10, double var12) {
