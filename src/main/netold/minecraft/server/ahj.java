...
public class ahj extends wv implements aho {
   ...
   public void s_() {
      ...
      if(this.i) {
         ...
         if(var6 != null) {
            if(var6.d != null) {
               var24 = uv.a(this.v * this.v + this.w * this.w + this.x * this.x);
               int var22 = uv.f((double)var24 * this.ar);
               if(this.l()) {
               ...
               if(var6.d.a(var26, (float)var22)) {
                  if(var6.d instanceof xm) {
                     ...
                     if(this.as > 0) {
                        var27 = uv.a(this.v * this.v + this.x * this.x);
                        if(var27 > 0.0F) {
               ...
               this.a(false);
               if(this.g.r() != bof.a) {
                  this.g.a(this.o, var21, var2, (wv)this);
               }
            }
         }
         ...
         this.t += this.w;
         this.u += this.x;
         var24 = uv.a(this.v * this.v + this.x * this.x);
