      ...
      for(boolean var28 = var25.nextInt(6) == 0; var15 < var16; ++var15) {
         ...
         if(var52 || var25.nextInt(4) != 0) {
            ...
            if(var6 >= var19 - 16.0D - var29 * 2.0D && var10 >= var21 - 16.0D - var29 * 2.0D && var6 <= var19 + 16.0D + var29 * 2.0D && var10 <= var21 + 16.0D + var29 * 2.0D) {
               int var53 = uv.c(var6 - var29) - var3 * 16 - 1;
               int var36 = uv.c(var6 + var29) - var3 * 16 + 1;
               int var55 = uv.c(var8 - var31) - 1;
               int var38 = uv.c(var8 + var31) + 1;
               int var54 = uv.c(var10 - var29) - var4 * 16 - 1;
                  ...
                  for(int var43 = var54; !var56 && var43 < var40; ++var43) {
                     for(int var44 = var38 + 1; !var56 && var44 >= var55 - 1; --var44) {
                        if(var44 >= 0 && var44 < 128) {
                           ...
                           if(var44 != var55 - 1 && var42 != var53 && var42 != var36 - 1 && var43 != var54 && var43 != var40 - 1) {
                              var44 = var55;
                           }
                        }
                     }
               ...
               if(!var56) {
                  for(var42 = var53; var42 < var36; ++var42) {
                     ...
                     for(int var57 = var54; var57 < var40; ++var57) {
                        double var46 = ((double)(var57 + var4 * 16) + 0.5D - var10) / var29;
