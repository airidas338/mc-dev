...
public class bmy {
   ...
   public static List a(Random var0, int var1) {
      ...
      var2.add(new bne(bng.class, 4, uv.a(var0, 2 + var1, 4 + var1 * 2)));
      var2.add(new bne(bni.class, 20, uv.a(var0, 0 + var1, 1 + var1)));
      var2.add(new bne(bna.class, 20, uv.a(var0, 0 + var1, 2 + var1)));
      var2.add(new bne(bnh.class, 3, uv.a(var0, 2 + var1, 5 + var1 * 3)));
      var2.add(new bne(bnf.class, 15, uv.a(var0, 0 + var1, 2 + var1)));
      var2.add(new bne(bnb.class, 3, uv.a(var0, 1 + var1, 4 + var1)));
      var2.add(new bne(bnc.class, 3, uv.a(var0, 2 + var1, 4 + var1 * 2)));
      var2.add(new bne(bnj.class, 15, uv.a(var0, 0, 1 + var1)));
      var2.add(new bne(bnm.class, 8, uv.a(var0, 0 + var1, 3 + var1 * 2)));
