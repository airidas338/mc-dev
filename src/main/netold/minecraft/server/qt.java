...
public class qt extends aqu implements vn {
               ...
               if(this.a(var4.a.a(-var5, -var5, -var5), var4.a.a(var5, var5, var5))) {
                  ...
                  if(var6.c().r() != bof.a && atr.a(var6.c(), var4.a())) {
                     try {
                        ...
                        bRenamed var8 = b.a(var10, "Exception while ticking a block");
   ...
   public void a(arb var1) {
      if(!this.x.w()) {
         try {
            ...
            bRenamed var3 = b.a(var6, "Exception initializing level");
   ...
   public void a(boolean var1, uy var2) throws aqz {
      if(this.v.e()) {
         if(var2 != null) {
            var2.a("Saving level");
         }
