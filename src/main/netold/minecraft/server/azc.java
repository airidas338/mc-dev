...
public class azc extends ati {
   ...
   protected boolean a(aqu var1, dt var2, bec var3, boolean var4, int var5) {
      if(var5 >= 8) {
         return false;
      } else {
         int var6 = var2.n();
   ...
   protected boolean a(aqu var1, dt var2, boolean var3, int var4, atl var5) {
