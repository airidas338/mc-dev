...
public class fn extends gd {
   ...
   private bRenamed a(String var1, int var2, ClassCastException var3) {
      bRenamed var4 = b.a(var3, "Reading NBT data");
   ...
   private static void a(String var0, gd var1, DataOutput var2) throws IOException {
   ...
   private static byte a(DataInput var0, fx var1) throws IOException {
      return var0.readByte();
   }

   private static String b(DataInput var0, fx var1) throws IOException {
      return var0.readUTF();
   }
   ...
   static gd a(byte var0, String var1, DataInput var2, int var3, fx var4) {
      ...
      try {
         ...
         bRenamed var7 = b.a(var9, "Loading NBT data");
