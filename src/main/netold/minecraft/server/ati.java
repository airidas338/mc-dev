...
public abstract class ati extends atr {
   ...
   public void a(aqu var1, dt var2, bec var3, atr var4) {
      if(!var1.D) {
         ...
         boolean var6 = false;
         if(!aqu.a((ard)var1, var2.b())) {
            var6 = true;
         }

         if(var5 == atl.c && !aqu.a((ard)var1, var2.f())) {
            var6 = true;
         } else if(var5 == atl.d && !aqu.a((ard)var1, var2.e())) {
            var6 = true;
         } else if(var5 == atl.e && !aqu.a((ard)var1, var2.c())) {
            var6 = true;
         } else if(var5 == atl.f && !aqu.a((ard)var1, var2.d())) {
            var6 = true;
         }
   ...
   protected void b(aqu var1, dt var2, bec var3, atr var4) {}

   protected bec a(aqu var1, dt var2, bec var3, boolean var4) {
