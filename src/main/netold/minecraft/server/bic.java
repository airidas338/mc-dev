...
public abstract class bic extends bhc {
   ...
   private boolean c(aqu var1, dt var2, int var3) {
      boolean var4 = true;
   ...
   private boolean a(dt var1, aqu var2) {
      dt var3 = var1.b();
   ...
   protected boolean a(aqu var1, Random var2, dt var3, int var4) {
      return this.c(var1, var3, var4) && this.a(var3, var1);
   }

   protected void a(aqu var1, dt var2, int var3) {
      int var4 = var3 * var3;
