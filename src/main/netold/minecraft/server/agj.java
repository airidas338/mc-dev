      ...
      if(super.a(var1, var2)) {
         ...
         if(var3 != null && this.o.aa() == vt.d && (double)this.V.nextFloat() < this.a(b).e()) {
            ...
            for(int var8 = 0; var8 < 50; ++var8) {
               ...
               if(aqu.a((ard)this.o, new dt(var9, var10 - 1, var11)) && this.o.l(new dt(var9, var10, var11)) < 10) {
                  var7.b((double)var9, (double)var10, (double)var11);
                  if(!this.o.B((double)var9, (double)var10, (double)var11, 7.0D) && this.o.a(var7.aQ(), (wv)var7) && this.o.a((wv)var7, var7.aQ()).isEmpty() && !this.o.d(var7.aQ())) {
                     this.o.d((wv)var7);
                     var7.d(var3);
