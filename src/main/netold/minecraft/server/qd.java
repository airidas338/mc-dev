...
public class qd extends JComponent {
   ...
   public qd(MinecraftServer var1) {
      this.e = var1;
      this.setPreferredSize(new Dimension(456, 246));
      this.setMinimumSize(new Dimension(456, 246));
      this.setMaximumSize(new Dimension(456, 246));
      (new Timer(500, new qe(this))).start();
   ...
   private void a() {
      ...
      this.d[1] = "Avg tick: " + aRenamed.format(this.a(this.e.g) * 1.0E-6D) + " ms";
      this.repaint();
   }
