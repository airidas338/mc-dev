...
public class tp extends tz {
   ...
   public tp(MinecraftServer var1, File var2) {
      this.c = var1;
      this.d = var2;
   }
   ...
   public void a(ahd var1, tq var2, int var3) {
      ...
      if(var2.d() && var4 == 0 && var3 > 0) {
         this.g = true;
         if(this.c.az()) {
            this.c.an().a((ho)(new hz("chat.type.achievement", new Object[]{var1.e_(), var2.j()})));
         }
      }
      ...
      if(var2.d() && var4 > 0 && var3 == 0) {
         this.g = true;
         if(this.c.az()) {
            this.c.an().a((ho)(new hz("chat.type.achievement.taken", new Object[]{var1.e_(), var2.j()})));
         }
      }
