...
public class ahk extends wv {
   ...
   public ahk(aqu var1, double var2, double var4, double var6) {
      super(var1);
      this.d = 0;
      this.a(0.25F, 0.25F);
   ...
   public void a(dt var1) {
      ...
      float var11 = uv.a(var7 * var7 + var9 * var9);
      if(var11 > 12.0F) {
   ...
   public void s_() {
      ...
      if(!this.o.D) {
         ...
         if(this.d > 80 && !this.o.D) {
            this.J();
            if(this.e) {
               this.o.d((wv)(new adw(this.o, this.s, this.t, this.u, new amj(amk.bH))));
            } else {
