...
public class bfh {
   ...
   public bfh(aqu var1, int var2, int var3) {
      this.d = new bfm[16];
      this.e = new byte[256];
      this.f = new int[256];
   ...
   public bfh(aqu var1, bgk var2, int var3, int var4) {
      this(var1, var3, var4);
      short var5 = 256;
      ...
      if(var2 >= 0 && var2 >> 4 < this.d.length) {
         ...
         if(var5 != null) {
            try {
               ...
               bRenamed var7 = bRenamed.a(var8, "Getting block");
               throw new u(var7);
            }
         }
      }
   ...
   public bec g(dt var1) {
      if(this.i.G() == are.g) {
         ...
         try {
            ...
            bRenamed var3 = bRenamed.a(var6, "Getting block state");
   ...
   public void a(wv var1, brt var2, List var3, Predicate var4) {
