...
public class rj implements ls, pm {
   ...
   public void a(mg var1) {
      ...
      if(!this.b.i) {
         ...
         if(this.r) {
            ...
            float var41 = 0.0625F;
            boolean var42 = var2.a((wv)this.b, this.b.aQ().d((double)var41, (double)var41, (double)var41)).isEmpty();
            ...
            if(!this.b.T) {
               boolean var46 = var2.a((wv)this.b, this.b.aQ().d((double)var41, (double)var41, (double)var41)).isEmpty();
   ...
   public void a(ml var1) {
      ...
      case 6:
         ...
         if(var10 > 36.0D) {
            ...
            if(var1.c() == mm.a) {
               if(!this.d.a((aqu)var2, var3, (ahd)this.b) && var2.af().a(var3)) {
   ...
   public void a(mx var1) {
      ...
      if(var1.b() == 255) {
         ...
         if(this.r && this.b.e((double)var5.n() + 0.5D, (double)var5.o() + 0.5D, (double)var5.p() + 0.5D) < 64.0D && !this.d.a((aqu)var2, var5, (ahd)this.b) && var2.af().a(var5)) {
      ...
      if(this.b.v()) {
         ...
         if(var2 != null) {
            ...
            if(var2.o != this.b.o) {
               ...
               if(this.b.ai()) {
                  var7.a((wv)this.b, false);
                  var8.d(this.b);
                  var8.a((wv)this.b, false);
               }
   ...
   public void a(id var1) {
      ...
      try {
         ...
         bRenamed var6 = b.a(var5, "Sending packet");
         ...
         if(!this.d.aj()) {
            ...
            try {
               ...
               if(var43 == 0) {
                  ...
                  wv var47 = this.b.o.a(var2.readInt());
               ...
               if(var46 != null) {
                  ...
                  var46.h();
                  this.b.a((ho)(new hz("advMode.setCommand.success", new Object[]{var50})));
               }
