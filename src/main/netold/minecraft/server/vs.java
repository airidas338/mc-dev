...
public class vs {
   ...
   public static void a(aqu var0, dt var1, vq var2) {
      a(var0, (double)var1.n(), (double)var1.o(), (double)var1.p(), var2);
   }

   public static void a(aqu var0, wv var1, vq var2) {
      a(var0, var1.s, var1.t, var1.u, var2);
   }

   private static void a(aqu var0, double var1, double var3, double var5, vq var7) {
      for(int var8 = 0; var8 < var7.n_(); ++var8) {
         amj var9 = var7.a(var8);
         if(var9 != null) {
   ...
   private static void a(aqu var0, double var1, double var3, double var5, amj var7) {
      ...
      while(var7.b > 0) {
         ...
         var7.b -= var11;
         adw var12 = new adw(var0, var1 + (double)var8, var3 + (double)var9, var5 + (double)var10, new amj(var7.b(), var11, var7.i()));
         if(var7.n()) {
            var12.l().d((fn)var7.o().b());
         }
