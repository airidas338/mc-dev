...
public class bde extends bdf implements bdd, pm {
   ...
   public static adw a(aqu var0, double var1, double var3, double var5) {
   ...
   public static vq b(aqu var0, double var1, double var3, double var5) {
      Object var7 = null;
      int var8 = uv.c(var1);
      int var9 = uv.c(var3);
      int var10 = uv.c(var5);
      ...
      if(var7 == null) {
         List var14 = var0.a((wv)null, new brt(var1, var3, var5, var1 + 1.0D, var3 + 1.0D, var5 + 1.0D), xe.c);
         if(var14.size() > 0) {
