...
public class abt extends abq implements vr {
   ...
   private void cW() {
      this.dd();
      if(!this.R()) {
         this.o.a((wv)this, "eating", 1.0F, 1.0F + (this.V.nextFloat() - this.V.nextFloat()) * 0.2F);
      }
   ...
   public void e(float var1, float var2) {
      ...
      if(var3 > 0) {
         ...
         if(var4.r() != bof.a && !this.R()) {
            atx var5 = var4.H;
            this.o.a((wv)this, var5.c(), var5.d() * 0.5F, var5.e() * 0.75F);
         }
   ...
   protected abt a(wv var1, double var2) {
   ...
   public boolean a(ahd var1) {
      ...
      if(var2 != null && var2.b() == amk.bJ) {
         ...
         if(var2 != null) {
            ...
            if(!this.cm() && !var3) {
               if(var2 != null && var2.a(var1, (xm)this)) {
                  return true;
               }
   ...
   public void cV() {
      this.a((wv)this, this.bC);
      this.cC();
   }

   private void a(wv var1, aic var2) {
   ...
   public ws a(ws var1) {
      ...
      var3.r(var6);
      double var14 = this.a(afs.a).b() + var1.a(afs.a).b() + (double)this.dg();
      var3.a(afs.a).a(var14 / 3.0D);
      double var13 = this.a(br).b() + var1.a(br).b() + this.dh();
      var3.a(br).a(var13 / 3.0D);
